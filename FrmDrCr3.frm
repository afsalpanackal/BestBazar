...
Private Sub CmdSave_Click()
    ...
    If OptCr.value = True Then
        ...
        rstBILL.Open "Select MAX(CR_NO) From STAFFPYMT WHERE TRX_TYPE = 'CB'", db, adOpenForwardOnly
    ...
    Else
        Set rstBILL = New ADODB.Recordset
        rstBILL.Open "Select MAX(CR_NO) From STAFFPYMT WHERE TRX_TYPE = 'DB'", db, adOpenForwardOnly
        If Not (rstBILL.EOF And rstBILL.BOF) Then
            txtBillNo.Text = IIf(IsNull(rstBILL.Fields(0)), 1, rstBILL.Fields(0) + 1)
        End If
        rstBILL.Close
