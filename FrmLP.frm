...
CLOSEFILE:
    ...
    '        Set rststock = Nothing
            ...
            For M = 1 To Val(grdsales.TextMatrix(n, 41))
                ...
                RSTTRXFILE!ITEM_COST = Decode_Cost(grdsales.TextMatrix(n, 15))
                ...
                With RSTRXFILE
                    If Not (.EOF And .BOF) Then
                        ...
                        If IsNull(RSTRXFILE!ITEM_SPEC) Then
                            pergr = 0
                        Else
                            pergr = IIf(IsNull(RSTRXFILE!ITEM_SPEC), 0, Val(RSTRXFILE!ITEM_SPEC))
                        End If
                    End If
                End With
                RSTRXFILE.Close
...
CLOSEFILE:
        ...
        '            Set rststock = Nothing
                    ...
                    For M = 1 To i
                        ...
                        RSTTRXFILE!ITEM_COST = Decode_Cost(grdsales.TextMatrix(grdsales.Row, 15))
