...
Private Sub cmdOK_Click()
    If OPTSLIP.Value = True Then
        FRMSALE.PRINTSLIP
    Else
        If FRMSALE.OPTAUTOMATIC = True Then
            FRMSALE.AutoPRINTBILL
        Else
            FRMSALE.PRINTBILL
        End If
    End If
