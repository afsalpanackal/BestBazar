...
Private Sub Command1_Click()
    ...
    For i = 0 To grdcount.Rows - 1
        ...
        RSTFLAG.Open "SELECT * from WAR_TRXFILE where VCH_NO = " & Val(grdcount.TextMatrix(i, 0)) & " AND LINE_NO = " & Val(grdcount.TextMatrix(i, 1)) & " ", db, adOpenStatic, adLockOptimistic, adCmdText
...
Public Function Fillgrid()
    ...
    With RSTWARTRX
        .Open "SELECT * From WAR_TRXFILE WHERE CHECK_FLAG='Y' AND (ISNULL(SETTLE_FLAG ) OR SETTLE_FLAG <>'Y') ORDER BY VCH_NO", db, adOpenForwardOnly
