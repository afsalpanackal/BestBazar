...
Begin VB.Form FRMSALESSV 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "SALES BILL - (Manual)"
   ClientHeight    =   11100
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   18495
   Icon            =   "FrmSalesSv.frx":0000
   KeyPreview      =   -1  'True
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame FRMEMAIN 
      ...
      Begin VB.Frame FRMEHEAD 
         ...
         Begin VB.ComboBox cmbtype 
            ...
            ForeColor       =   &H00FF0000&
            Height          =   315
            ItemData        =   "FrmSalesSv.frx":030A
            Left            =   8355
            List            =   "FrmSalesSv.frx":031A
...
Private Sub Cmdbillconvert_Click()
    ...
    frmINVTYPE.OptPetty.Value = True
End Sub
...
'    RSTTRXFILE.Open "SELECT *  FROM TEMPCN WHERE ACT_CODE = '" & Trim(DataList2.BoundText) & "' AND BILL_NO = " & Val(txtBillNo.Text) & " AND BILL_TRX_TYPE = 'SV' AND TRX_TYPE = 'SV'", db, adOpenStatic, adLockOptimistic, adCmdText
...
'    Set RSTTRXFILE = Nothing
    ...
    For n = 1 To grdsales.rows - 1
        ...
        If grdsales.TextMatrix(n, 19) = "DN" Then
            Set RSTTRXFILE = New ADODB.Recordset
            'RSTTRXFILE.Open "SELECT *  FROM TEMPCN WHERE ACT_CODE = '" & Trim(DataList2.BoundText) & "' AND TRX_TYPE = 'SV' AND VCH_NO = " & Val(grdsales.TextMatrix(n, 35)) & " AND LINE_NO = " & Val(grdsales.TextMatrix(n, 37)) & " ", db, adOpenStatic, adLockOptimistic, adCmdText
...
'    If TXTITEMCODE.Enabled = False Then Exit Sub
...
'
'    lines() = Split(TxtQRCode.Text, vbCrLf)
'
''        Print (i + 1) & ": " & lines(i)
''        Next
'    Screen.MousePointer = vbHourglass
'    For i = 0 To UBound(lines)
'        If Left(Trim(lines(i)), 1) = "#" And Len(Trim(lines(i))) >= 11 Then
'            itemcode = Mid(Trim(lines(i)), 2, 5)
'            uomflag = Val(Mid(Trim(lines(i)), 12, 1))
'            If uomflag = 1 Then
'                itemqty = Val(Mid(Trim(lines(i)), 7, 5))
'            Else
'                itemqty = Val(Mid(Trim(lines(i)), 7, 5)) / 1000
'            End If
'            Set grdtmp.DataSource = Nothing
...
'    Set RSTUNBILL = Nothing
    ...
    If CMBDISTI.BoundText <> "" Or (lblsubdealer.Caption = "D" And Val(lblActAmt.Caption) <> 0) Then
        db.Execute "Update TRXMAST set COMM_AMT = " & Val(lblcomamt.text) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='SV' AND VCH_NO = " & Val(txtBillNo.text) & ""
    End If
...
'    db.Execute "SET SESSION TRANSACTION ISOLATION LEVEL READ COMMITTED"
    ...
    For n = 0 To grdcount.rows - 1
        ...
        Set RSTTRXFILE = New ADODB.Recordset
        RSTTRXFILE.Open "Select * FROM TRXSUB WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='SV' AND VCH_NO = " & Val(txtBillNo.text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(grdsales.rows - 1, 32)) & "", db, adOpenStatic, adLockOptimistic, adCmdText
        If (RSTTRXFILE.EOF And RSTTRXFILE.BOF) Then
            RSTTRXFILE.AddNew
            RSTTRXFILE!VCH_NO = Val(txtBillNo.text)
            RSTTRXFILE!TRX_TYPE = "SV"
        ...
        Set RSTTRXFILE = New ADODB.Recordset
        RSTTRXFILE.Open "Select * FROM TRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='SV' AND VCH_NO = " & Val(txtBillNo.text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(grdsales.rows - 1, 32)) & "", db, adOpenStatic, adLockOptimistic, adCmdText
        If (RSTTRXFILE.EOF And RSTTRXFILE.BOF) Then
            RSTTRXFILE.AddNew
            RSTTRXFILE!TRX_TYPE = "SV"
            RSTTRXFILE!TRX_YEAR = Year(MDIMAIN.DTFROM.Value)
...
Private Function COSTCALCULATION()
    ...
    If Val(LBLTOTALCOST.Caption) <> 0 Then
        lbltotprofper.Caption = Round((Val(LBLPROFIT.Caption) * 100) / Val(LBLTOTALCOST.Caption), 2)
        lbltotprofper.Caption = Format(Val(lbltotprofper.Caption), "0.00")
    End If
    Exit Function
        ...
        Case vbKeyReturn
            Select Case grdsales.Col
                ...
                Case 3 'Qty
                    ...
                    db.Execute "Update TRXFILE set QTY = " & Val(grdsales.TextMatrix(grdsales.Row, 3)) & ", TRX_TOTAL = " & Val(grdsales.TextMatrix(grdsales.Row, 12)) & ", SCHEME = " & Val(TXTDISC.Tag) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='SV' AND VCH_NO = " & Val(txtBillNo.text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(grdsales.Row, 32)) & ""
                    If CMBDISTI.BoundText <> "" Or (lblsubdealer.Caption = "D" And Val(lblActAmt.Caption) <> 0) Then
                        db.Execute "Update TRXMAST set COMM_AMT = " & Val(lblcomamt.text) & ", PAY_AMOUNT = " & Val(LBLTOTALCOST.Caption) & ", ADD_AMOUNT = " & Val(LBLRETAMT.Caption) & ", DISCOUNT = " & Val(TXTTOTALDISC.text) & ", DISC_PERS  = " & Val(TXTTOTALDISC.text) & ", VCH_AMOUNT = " & Val(LBLTOTAL.Caption) & ", NET_AMOUNT = " & Val(lblnetamount.Caption) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='SV' AND VCH_NO = " & Val(txtBillNo.text) & ""
                    Else
                        db.Execute "Update TRXMAST set COMM_AMT = 0, PAY_AMOUNT = " & Val(LBLTOTALCOST.Caption) & ", ADD_AMOUNT = " & Val(LBLRETAMT.Caption) & ", DISCOUNT = " & Val(TXTTOTALDISC.text) & ", DISC_PERS  = " & Val(TXTTOTALDISC.text) & ", VCH_AMOUNT = " & Val(LBLTOTAL.Caption) & ", NET_AMOUNT = " & Val(lblnetamount.Caption) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='SV' AND VCH_NO = " & Val(txtBillNo.text) & ""
                ...
                Case 5  'MRP
                    grdsales.TextMatrix(grdsales.Row, grdsales.Col) = Format(Val(TXTsample.text), "0.000")
                    db.Execute "Update TRXFILE set MRP = " & Val(grdsales.TextMatrix(grdsales.Row, 5)) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='SV' AND VCH_NO = " & Val(txtBillNo.text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(grdsales.Row, 32)) & ""
                    grdsales.Enabled = True
                    TXTsample.Visible = False
                ...
                Case 8  'Disc
                    ...
                    db.Execute "Update TRXFILE set LINE_DISC = " & Val(grdsales.TextMatrix(grdsales.Row, 8)) & ", TRX_TOTAL = " & Val(grdsales.TextMatrix(grdsales.Row, 12)) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='SV' AND VCH_NO = " & Val(txtBillNo.text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(grdsales.Row, 32)) & ""
                    If CMBDISTI.BoundText <> "" Or (lblsubdealer.Caption = "D" And Val(lblActAmt.Caption) <> 0) Then
                        db.Execute "Update TRXMAST set COMM_AMT = " & Val(lblcomamt.text) & ", PAY_AMOUNT = " & Val(LBLTOTALCOST.Caption) & ", ADD_AMOUNT = " & Val(LBLRETAMT.Caption) & ", DISCOUNT = " & Val(TXTTOTALDISC.text) & ", DISC_PERS  = " & Val(TXTTOTALDISC.text) & ", VCH_AMOUNT = " & Val(LBLTOTAL.Caption) & ", NET_AMOUNT = " & Val(lblnetamount.Caption) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='SV' AND VCH_NO = " & Val(txtBillNo.text) & ""
                    Else
                        db.Execute "Update TRXMAST set COMM_AMT = 0, PAY_AMOUNT = " & Val(LBLTOTALCOST.Caption) & ", ADD_AMOUNT = " & Val(LBLRETAMT.Caption) & ", DISCOUNT = " & Val(TXTTOTALDISC.text) & ", DISC_PERS  = " & Val(TXTTOTALDISC.text) & ", VCH_AMOUNT = " & Val(LBLTOTAL.Caption) & ", NET_AMOUNT = " & Val(lblnetamount.Caption) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='SV' AND VCH_NO = " & Val(txtBillNo.text) & ""
                ...
                Case 24  'Commission
                    ...
                    db.Execute "Update TRXFILE set COM_AMT = " & Val(grdsales.TextMatrix(grdsales.Row, 24)) & "  WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='SV' AND VCH_NO = " & Val(txtBillNo.text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(grdsales.Row, 32)) & ""
                    db.Execute "Update DBTPYMT set INV_AMT = " & Val(lblnetamount.Caption) & ", COMM_AMT = " & Val(lblcomamt.text) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND INV_NO = " & Val(txtBillNo.text) & " AND TRX_TYPE = 'DR' AND INV_TRX_TYPE = 'SV'"
                    If CMBDISTI.BoundText <> "" Or (lblsubdealer.Caption = "D" And Val(lblActAmt.Caption) <> 0) Then
                        db.Execute "Update TRXMAST set COMM_AMT = " & Val(lblcomamt.text) & ", PAY_AMOUNT = " & Val(LBLTOTALCOST.Caption) & ", ADD_AMOUNT = " & Val(LBLRETAMT.Caption) & ", DISCOUNT = " & Val(TXTTOTALDISC.text) & ", DISC_PERS  = " & Val(TXTTOTALDISC.text) & ", VCH_AMOUNT = " & Val(LBLTOTAL.Caption) & ", NET_AMOUNT = " & Val(lblnetamount.Caption) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='SV' AND VCH_NO = " & Val(txtBillNo.text) & ""
                    Else
...
'        End If
        ...
        If lblcredit.Caption = "0" Then
            ...
            If GRDRECEIPT.rows > 1 And Trim(GRDRECEIPT.TextMatrix(2, 0)) = "B" Then
                ...
                BANKTRX!REF_NO = "SALES - " & txtBillNo.text 'DataList2.Text
...
'    db.Execute "Update TRXFILE set VCH_DESC =  '" & Trim(Rcvd_Party) & "' WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SV' AND VCH_NO = " & Val(txtBillNo.Text) & " "
...
'    OLD_BILL = True
    ...
    For i = 1 To grdsales.rows - 1
        ...
        If (thermalprn = False And (grdsales.TextMatrix(i, 46) = "Y" And MDIMAIN.lblprnall.Caption = "N")) Then GoTo SKIP_UNBILL
...
'        End If
        ...
        RSTTRXFILE!MRP = Val(grdsales.TextMatrix(i, 5))
        RSTTRXFILE!PTR = Val(grdsales.TextMatrix(i, 7)) 'Val(grdsales.TextMatrix(i, 6))
        RSTTRXFILE!SALES_PRICE = Val(grdsales.TextMatrix(i, 7))
        RSTTRXFILE!SALES_TAX = 0 'grdsales.TextMatrix(i, 9)
        RSTTRXFILE!UNIT = grdsales.TextMatrix(i, 4)
        ...
        RSTTRXFILE!P_RETAILWOTAX = Val(grdsales.TextMatrix(i, 7)) 'Val(grdsales.TextMatrix(i, 6)) 'Val(grdsales.TextMatrix(i, 22))
...
SKIP_UNBILL:
    ...
    Do Until rstTRXMAST.EOF
        ...
        RSTTRXFILE!PTR = -rstTRXMAST!SALES_PRICE
        RSTTRXFILE!SALES_PRICE = -rstTRXMAST!SALES_PRICE
        RSTTRXFILE!SALES_TAX = 0 'rstTRXMAST!SALES_TAX
        ...
        RSTTRXFILE!P_RETAILWOTAX = -(rstTRXMAST!SALES_PRICE + (rstTRXMAST!SALES_PRICE * rstTRXMAST!SALES_TAX / 100))
...
CLOSEFILE:
        ...
        If MDIMAIN.lblgst.Caption = "C" Then
            ...
            ReportNameVar = Rptpath & "RPTOUTPASSCSV"
        Else
            ReportNameVar = Rptpath & "RPTOUTPASSNSV"
        End If
    ...
    If Val(MDIMAIN.StatusBar.Panels(10).text) = 1 Then
        If Small_Print = True Then
            If MDIMAIN.lblgst.Caption = "C" Then
                ReportNameVar = Rptpath & "rptGSTBILLCSVA51"
            Else
                ReportNameVar = Rptpath & "rptGSTBILLNSVA51"
            End If
        Else
            If MDIMAIN.lblgst.Caption = "C" Then
                ReportNameVar = Rptpath & "rptGSTBILLCSV1"
            Else
                ReportNameVar = Rptpath & "rptGSTBILLNSV1"
            End If
        End If
        Set Report = crxApplication.OpenReport(ReportNameVar, 1)
    ...
    Else
        If Small_Print = True Then
            If MDIMAIN.lblgst.Caption = "C" Then
                ReportNameVar = Rptpath & "rptGSTBILLCSVA5"
            Else
                ReportNameVar = Rptpath & "rptGSTBILLNSVA5"
            End If
        Else
            If MDIMAIN.lblgst.Caption = "C" Then
                ReportNameVar = Rptpath & "rptGSTBILLCSV"
            Else
                ReportNameVar = Rptpath & "rptGSTBILLNSV"
            End If
        End If
        ...
        If Val(MDIMAIN.StatusBar.Panels(10).text) > 2 Then
            ...
            Report.OpenSubreport("RPTBILL3rpt").DiscardSavedData
        End If
...
Public Function Make_Invoice(BillType As String)
    If BillType = "SV" Then Exit Function
    Dim RSTTRXFILE As ADODB.Recordset
    Dim RSTP_RATE As ADODB.Recordset
    Dim RSTITEMMAST As ADODB.Recordset
    Dim rstMaxRec As ADODB.Recordset
    ...
    Select Case KeyCode
        Case vbKeyReturn, vbKeyEscape
            ...
            For i = 1 To grdsales.rows - 1
                ...
                db.Execute "Update TRXFILE set COM_AMT = " & Val(grdsales.TextMatrix(i, 24)) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='SV' AND VCH_NO = " & Val(txtBillNo.text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(i, 32)) & " "
