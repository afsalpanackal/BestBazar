...
Begin VB.Form FRMAGENTREG 
   ...
   Begin VB.Frame FRMEMAIN 
      ...
      Top             =   -270
      Width           =   16440
      Begin VB.CommandButton CMDCATWISE 
         Caption         =   "PRINT CATEGORY WISE"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   204
      ...
      Begin vbalProgBarLib6.vbalProgressBar vbalProgressBar1 
         ...
         _ExtentX        =   9895
         _ExtentY        =   582
         Picture         =   "frmagentreg.frx":030A
         ForeColor       =   0
         BarPicture      =   "frmagentreg.frx":0326
         Max             =   150
         Text            =   "PLEASE WAIT..."
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
...
Private Sub CMDCATWISE_Click()
    Screen.MousePointer = vbHourglass
    
    On Error GoTo ERRHAND
    ReportNameVar = Rptpath & "RPTCOMMIREGCAT"
...
Private Sub CmDDisplay_Click()
    ...
    If OPTPERIOD.Value = True Then
        ...
        Else
            If OptPetty.Visible = True Then
                rstTRANX.Open "SELECT * From TRXMAST WHERE VCH_DATE <= '" & Format(DTTo.Value, "yyyy/mm/dd") & "' AND VCH_DATE >= '" & Format(DTFROM.Value, "yyyy/mm/dd") & "' AND (TRX_TYPE='SV' OR TRX_TYPE='GI' or TRX_TYPE='HI' OR TRX_TYPE='RI' OR TRX_TYPE='WO') ORDER BY TRX_TYPE, VCH_DATE,VCH_NO", db, adOpenStatic, adLockReadOnly
            Else
                rstTRANX.Open "SELECT * From TRXMAST WHERE VCH_DATE <= '" & Format(DTTo.Value, "yyyy/mm/dd") & "' AND VCH_DATE >= '" & Format(DTFROM.Value, "yyyy/mm/dd") & "' AND (TRX_TYPE='SV' OR TRX_TYPE='GI' or TRX_TYPE='HI' OR TRX_TYPE='RI') ORDER BY TRX_TYPE, VCH_DATE,VCH_NO", db, adOpenStatic, adLockReadOnly
            End If
        End If
    Else
        If OptGST.Value = True Then
            rstTRANX.Open "SELECT * From TRXMAST WHERE AGENT_CODE = '" & DataList2.BoundText & "' AND VCH_DATE <= '" & Format(DTTo.Value, "yyyy/mm/dd") & "' AND VCH_DATE >= '" & Format(DTFROM.Value, "yyyy/mm/dd") & "' AND TRX_TYPE='GI'  ORDER BY TRX_TYPE, VCH_DATE,VCH_NO", db, adOpenStatic, adLockReadOnly
        ElseIf OptVan.Value = True Then
            rstTRANX.Open "SELECT * From TRXMAST WHERE AGENT_CODE = '" & DataList2.BoundText & "' AND VCH_DATE <= '" & Format(DTTo.Value, "yyyy/mm/dd") & "' AND VCH_DATE >= '" & Format(DTFROM.Value, "yyyy/mm/dd") & "' AND TRX_TYPE='HI'  ORDER BY TRX_TYPE, VCH_DATE,VCH_NO", db, adOpenStatic, adLockReadOnly
        ElseIf OptService.Value = True Then
            rstTRANX.Open "SELECT * From TRXMAST WHERE AGENT_CODE = '" & DataList2.BoundText & "' AND VCH_DATE <= '" & Format(DTTo.Value, "yyyy/mm/dd") & "' AND VCH_DATE >= '" & Format(DTFROM.Value, "yyyy/mm/dd") & "' AND TRX_TYPE='SV'  ORDER BY TRX_TYPE, VCH_DATE,VCH_NO", db, adOpenStatic, adLockReadOnly
        ElseIf OptPetty.Value = True Then
            rstTRANX.Open "SELECT * From TRXMAST WHERE AGENT_CODE = '" & DataList2.BoundText & "' AND VCH_DATE <= '" & Format(DTTo.Value, "yyyy/mm/dd") & "' AND VCH_DATE >= '" & Format(DTFROM.Value, "yyyy/mm/dd") & "' AND TRX_TYPE='WO'  ORDER BY TRX_TYPE, VCH_DATE,VCH_NO", db, adOpenStatic, adLockReadOnly
        Else
            If OptPetty.Visible = True Then
                rstTRANX.Open "SELECT * From TRXMAST WHERE AGENT_CODE = '" & DataList2.BoundText & "' AND VCH_DATE <= '" & Format(DTTo.Value, "yyyy/mm/dd") & "' AND VCH_DATE >= '" & Format(DTFROM.Value, "yyyy/mm/dd") & "' AND (TRX_TYPE='SV' OR TRX_TYPE='GI' OR TRX_TYPE='HI' OR TRX_TYPE='RI' OR TRX_TYPE='WO') ORDER BY TRX_TYPE, VCH_DATE,VCH_NO", db, adOpenStatic, adLockReadOnly
            Else
                rstTRANX.Open "SELECT * From TRXMAST WHERE AGENT_CODE = '" & DataList2.BoundText & "' AND VCH_DATE <= '" & Format(DTTo.Value, "yyyy/mm/dd") & "' AND VCH_DATE >= '" & Format(DTFROM.Value, "yyyy/mm/dd") & "' AND (TRX_TYPE='SV' OR TRX_TYPE='GI' OR TRX_TYPE='HI' OR TRX_TYPE='RI') ORDER BY TRX_TYPE, VCH_DATE,VCH_NO", db, adOpenStatic, adLockReadOnly
            End If
        End If
    End If
    ...
    Do Until rstTRANX.EOF
        ...
        GRDTranx.TextMatrix(M, 5) = Format(Round(rstTRANX!NET_AMOUNT, 2), "0.00") 'Format(Round(Val(GRDTranx.TextMatrix(M, 3)) - Val(GRDTranx.TextMatrix(M, 4)), 0), "0.00")
        ...
        GRDTranx.TextMatrix(M, 11) = IIf(IsNull(rstTRANX!TRX_TYPE), "", rstTRANX!TRX_TYPE)
...
Private Sub GRDTranx_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    Select Case KeyCode
        Case vbKeyReturn
            ...
            RSTTRXFILE.Open "Select * From TRXFILE WHERE VCH_NO = " & Val(LBLBILLNO.Caption) & " AND TRX_TYPE = '" & GRDTranx.TextMatrix(GRDTranx.Row, 11) & "' AND TRX_YEAR = '" & GRDTranx.TextMatrix(GRDTranx.Row, 12) & "'", db, adOpenStatic, adLockReadOnly
