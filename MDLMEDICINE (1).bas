...
'                        db.Execute "Update COMPINFO set EC =0"
            ...
            If DateDiff("d", Date, dt_from) <= 15 Then
...
'''    Dim BILL_NO As Long
'''
'''    'ord_no INT NOT NULL, act_code VARCHAR(25) NULL, act_name VARCHAR(100) NULL, act_address Text(200) NULL, act_phone TEXT(15), C_USER_ID TEXT(4), C_USER_NAME TEXT(50), C_USER_DATE DATE, M_USER_ID TEXT(4), M_USER_NAME TEXT(50), M_USER_DATE DATE, PRIMARY KEY (ord_no)) ENGINE = InnoDB"
'''
'''    db.Execute "delete from orders"
'''    Set RSTTRXFILE = New ADODB.Recordset
'''    RSTTRXFILE.Open "Select * From orders", db, adOpenStatic, adLockOptimistic, adCmdText
'''    'line_no INT NOT NULL, item_code VARCHAR(25) NULL, item_name VARCHAR(200) NULL, item_uprice double null, item_qty double null, item_tprice double null, PRIMARY KEY (ord_no, COMP_CODE, ACT_CODE, line_no)) ENGINE = InnoDB"
'''    For I = 1 To p.COUNT
'''        RSTTRXFILE.AddNew
...
'
'    dbexport.Execute "CREATE TABLE " & TABLE_NAME & " (`TRX_TYPE` VARCHAR( 2 ) NOT NULL ,`VCH_NO` DOUBLE NOT NULL ,`TRX_YEAR` VARCHAR( 4 ) NOT NULL ,`VCH_DATE` date NULL , `NET_AMOUNT` DOUBLE NOT NULL ,PRIMARY KEY ( `TRX_TYPE` , `VCH_NO` , `TRX_YEAR` )) ENGINE = InnoDB;"
'
'    Set rstTRXMAST = New ADODB.Recordset
...
'    TABLE_NAME = "TRXEXPMAST" & customercode
'    dbexport.Execute "DROP TABLE if exists " & TABLE_NAME & " "
'    dbexport.Execute "CREATE TABLE " & TABLE_NAME & " (`TRX_TYPE` VARCHAR( 2 ) NOT NULL ,`VCH_NO` DOUBLE NOT NULL ,`TRX_YEAR` VARCHAR( 4 ) NOT NULL ,`VCH_DATE` date NULL , `VCH_AMOUNT` DOUBLE NOT NULL ,PRIMARY KEY ( `TRX_TYPE` , `VCH_NO` , `TRX_YEAR` )) ENGINE = InnoDB;"
'
'    TABLE_NAME = "TRXEXP_MAST" & customercode
'    dbexport.Execute "DROP TABLE if exists " & TABLE_NAME & " "
'    dbexport.Execute "CREATE TABLE " & TABLE_NAME & " (`TRX_TYPE` VARCHAR( 2 ) NOT NULL ,`VCH_NO` DOUBLE NOT NULL ,`TRX_YEAR` VARCHAR( 4 ) NOT NULL ,`VCH_DATE` date NULL , `VCH_AMOUNT` DOUBLE NOT NULL ,PRIMARY KEY ( `TRX_TYPE` , `VCH_NO` , `TRX_YEAR` )) ENGINE = InnoDB;"
...
'    TABLE_NAME = "RETURNMAST" & customercode
'    dbexport.Execute "DROP TABLE if exists " & TABLE_NAME & " "
'    dbexport.Execute "CREATE TABLE " & TABLE_NAME & " (`TRX_TYPE` VARCHAR( 2 ) NOT NULL ,`VCH_NO` DOUBLE NOT NULL ,`TRX_YEAR` VARCHAR( 4 ) NOT NULL ,`VCH_AMOUNT` DOUBLE NOT NULL ,PRIMARY KEY ( `TRX_TYPE` , `VCH_NO` , `TRX_YEAR` )) ENGINE = InnoDB;"
'
'    TABLE_NAME = "RTRXFILE" & customercode
'    dbexport.Execute "DROP TABLE if exists " & TABLE_NAME & " "
'    dbexport.Execute "CREATE TABLE " & TABLE_NAME & " (`TRX_TYPE` VARCHAR( 2 ) NOT NULL ,`VCH_NO` DOUBLE NOT NULL ,`TRX_YEAR` VARCHAR( 4 ) NOT NULL ,`TRX_TOTAL` DOUBLE NOT NULL ,PRIMARY KEY ( `TRX_TYPE` , `VCH_NO` , `TRX_YEAR` )) ENGINE = InnoDB;"
'
'     TABLE_NAME = "CRDTPYMT" & customercode
'    dbexport.Execute "DROP TABLE if exists " & TABLE_NAME & " "
'    dbexport.Execute "CREATE TABLE " & TABLE_NAME & " (`TRX_TYPE` VARCHAR( 2 ) NOT NULL ,`CR_NO` DOUBLE NOT NULL ,`TRX_YEAR` VARCHAR( 4 ) NOT NULL ,`ACT_NAME` varchar(150) NULL ,`RCPT_AMOUNT` DOUBLE NULL ,`RCPT_DATE` datetime NULL ,`INV_NO` DOUBLE NULL ,`INV_DATE` date NULL ,`REF_NO` varchar(30) NULL ,PRIMARY KEY ( `CR_NO` , `TRX_TYPE`)) ENGINE = InnoDB;"
'
'    TABLE_NAME = "DBTPYMT" & customercode
'    dbexport.Execute "DROP TABLE if exists " & TABLE_NAME & " "
'    dbexport.Execute "CREATE TABLE " & TABLE_NAME & " (`TRX_TYPE` VARCHAR( 2 ) NOT NULL ,`CR_NO` DOUBLE NOT NULL ,`TRX_YEAR` VARCHAR( 4 ) NOT NULL ,`ACT_NAME` varchar(150) NULL ,`RCPT_AMT` DOUBLE NULL ,`RCPT_DATE` datetime NULL ,`INV_NO` DOUBLE NULL ,`INV_DATE` date NULL ,`REF_NO` varchar(100) NULL ,PRIMARY KEY ( `CR_NO` , `TRX_TYPE` )) ENGINE = InnoDB;"
'
'    TABLE_NAME = "ACTMAST" & customercode
'    dbexport.Execute "DROP TABLE if exists " & TABLE_NAME & " "
'    dbexport.Execute "CREATE TABLE " & TABLE_NAME & " (`ACT_CODE` VARCHAR( 6 ) NOT NULL ,`OPEN_DB` DOUBLE NULL ,PRIMARY KEY ( `ACT_CODE` )) ENGINE = InnoDB;"
'
'    TABLE_NAME = "CASHATRXFILE" & customercode
'    dbexport.Execute "DROP TABLE if exists " & TABLE_NAME & " "
'    dbexport.Execute "CREATE TABLE " & TABLE_NAME & " (`TRX_TYPE` VARCHAR( 2 ) NOT NULL ,`REC_NO` DOUBLE NOT NULL ,`INV_TRX_TYPE` VARCHAR( 2 ) NOT NULL ,`INV_TYPE` varchar(2) NULL ,`INV_NO` INT (11) NOT NULL ,`VCH_DATE` date NULL ,`CHECK_FLAG` varchar(1) NULL ,`AMOUNT` double NULL , PRIMARY KEY ( `TRX_TYPE` , `REC_NO`, `INV_TRX_TYPE`, `INV_TYPE`, `INV_NO` )) ENGINE = InnoDB;"
'
'    TABLE_NAME = "BANK_TRX" & customercode
'    dbexport.Execute "DROP TABLE if exists " & TABLE_NAME & " "
