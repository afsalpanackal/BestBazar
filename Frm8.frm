...
Private Sub CmdDeleteAll_Click()
    ...
    If DUPLI_BILL = True Then
        MsgBox "Cannot modify here since not created here", vbOKOnly, "Sales"
        Exit Sub
    End If
...
'    End If
    ...
    db2.Execute "Delete FROM TRXSUB WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & " "
    db2.Execute "Delete FROM TRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & " "
    For n = 1 To grdsales.Rows - 1
        Set RSTTRXFILE = New ADODB.Recordset
...
Private Sub CMDADD_Click()
    ...
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "Select * FROM TRXMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & "", db2, adOpenStatic, adLockOptimistic, adCmdText
    If (RSTTRXFILE.EOF And RSTTRXFILE.BOF) Then
        RSTTRXFILE.AddNew
        RSTTRXFILE!VCH_NO = Val(txtBillNo.Text)
        RSTTRXFILE!TRX_TYPE = "SI"
    ...
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "Select * FROM TRXSUB WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(Val(TXTSLNO.Text), 32)) & "", db2, adOpenStatic, adLockOptimistic, adCmdText
    If (RSTTRXFILE.EOF And RSTTRXFILE.BOF) Then
        RSTTRXFILE.AddNew
        RSTTRXFILE!VCH_NO = Val(txtBillNo.Text)
        RSTTRXFILE!TRX_TYPE = "SI"
    ...
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "Select * FROM TRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(Val(TXTSLNO.Text), 32)) & "", db2, adOpenStatic, adLockOptimistic, adCmdText
    If (RSTTRXFILE.EOF And RSTTRXFILE.BOF) Then
        RSTTRXFILE.AddNew
        RSTTRXFILE!TRX_TYPE = "SI"
        RSTTRXFILE!TRX_YEAR = Year(MDIMAIN.DTFROM.value)
...
Private Sub CmdDelete_Click()
    ...
    db2.Execute "Delete FROM TRXSUB WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(Val(TXTSLNO.Text), 32)) & ""
    db2.Execute "Delete FROM TRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(Val(TXTSLNO.Text), 32)) & ""
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "SELECT *  FROM ITEMMAST WHERE ITEM_CODE = '" & grdsales.TextMatrix(Val(TXTSLNO.Text), 13) & "'", db2, adOpenStatic, adLockOptimistic, adCmdText
    With RSTTRXFILE
        If Not (.EOF And .BOF) Then
...
Private Sub Form_Load()
    ...
    rstBILL.Open "Select MAX(Val(VCH_NO)) From TRXMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE = 'SI'", db2, adOpenStatic, adLockReadOnly
...
Private Sub TXTBILLNO_KeyDown(KeyCode As Integer, Shift As Integer)
    Dim TRXMAST As ADODB.Recordset
    Dim TRXMAST2 As ADODB.Recordset
    ...
    Select Case KeyCode
        Case vbKeyReturn
            ...
            grdsales.Rows = 1
            Set TRXMAST = New ADODB.Recordset
            TRXMAST.Open "Select * FROM TRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & " ", db2, adOpenStatic, adLockReadOnly
            If Not (TRXMAST.EOF Or TRXMAST.BOF) Then
                Set TRXMAST2 = New ADODB.Recordset
                TRXMAST2.Open "Select * FROM TRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & " ", db, adOpenStatic, adLockReadOnly
                If Not (TRXMAST2.EOF Or TRXMAST2.BOF) Then
                    DUPLI_BILL = False
                Else
                    DUPLI_BILL = True
                End If
                TRXMAST2.Close
                Set TRXMAST2 = Nothing
            Else
                DUPLI_BILL = False
            End If
            TRXMAST.Close
            ...
            If DUPLI_BILL = True Then
                TRXSUB.Open "Select * FROM TRXSUB WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & " ORDER BY LINE_NO", db2, adOpenStatic, adLockReadOnly
            Else
            ...
            Do Until TRXSUB.EOF
                ...
                If DUPLI_BILL = True Then
                    TRXFILE.Open "Select * From TRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & " AND LINE_NO = " & Val(TRXSUB!LINE_NO) & "", db2, adOpenStatic, adLockReadOnly
                Else
            ...
            Set TRXMAST = New ADODB.Recordset
            If DUPLI_BILL = True Then
                TRXMAST.Open "Select * FROM TRXMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & "", db2, adOpenStatic, adLockReadOnly
            Else
            ...
            Dim rstBILL As ADODB.Recordset
            Set rstBILL = New ADODB.Recordset
            rstBILL.Open "Select MAX(Val(VCH_NO)) From TRXMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE = 'SI'", db2, adOpenForwardOnly
            If Not (rstBILL.EOF And rstBILL.BOF) Then
...
Private Sub txtBillNo_LostFocus()
    ...
    On Error GoTo ErrHand
    Set TRXMAST = New ADODB.Recordset
    TRXMAST.Open "Select * FROM TRXMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & " AND BILL_FLAG ='Y' ", db2, adOpenStatic, adLockReadOnly
    If Not (TRXMAST.EOF Or TRXMAST.BOF) Then
        txtBillNo.Tag = "Y"
    Else
        txtBillNo.Tag = "N"
...
Public Function AppendSale()
    ...
    db2.Execute "Delete FROM TRXMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & ""
    'db.Execute "Delete FROM TRXSUB WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & ""
    'db.Execute "Delete FROM TRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & ""
    ...
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "Select * FROM TRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='SI' AND VCH_NO = " & Val(txtBillNo.Text) & " ", db2, adOpenStatic, adLockOptimistic, adCmdText
    Do Until RSTTRXFILE.EOF
        RSTTRXFILE!VCH_DATE = Format(TXTINVDATE.Text, "DD/MM/YYYY")
        RSTTRXFILE.Update
        RSTTRXFILE.MoveNext
