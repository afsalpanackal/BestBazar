...
Begin VB.Form FRMBILLPRINT 
   ...
   Begin VB.ComboBox CMBMONTH 
      ForeColor       =   &H000000FF&
      Height          =   330
      ItemData        =   "FRMBILLPRINT.frx":030A
      Left            =   2310
      List            =   "FRMBILLPRINT.frx":0332
...
SKIP:
    ...
    Set rstTMP = New ADODB.Recordset
    rstTMP.Open "Select Max(Val(VCH_NO)) From SALEBILL", db2, adOpenStatic, adLockReadOnly
    If Not (rstTMP.EOF And rstTMP.BOF) Then
        i = rstTMP.Fields(0)
    End If
    rstTMP.Close
    ...
    LBLBILLNOS.Caption = i - Val(txtBillNo.Text) & " NOs."
