...
'    End If
    If Val(MDIMAIN.StatusBar.Panels(11).Text) = 1 Then
        ...
        Report.RecordSelectionFormula = "({TRXFILE.TRX_TYPE}= 'DM' AND {TRXFILE.VCH_NO}= " & Val(txtBillNo.Text) & " )"
        If Val(lblnetamount.Caption) >= Val(MDIMAIN.LBLHSNSUM.Caption) Or Trim(lblIGST.Caption) = "Y" Then
            For i = 1 To Report.OpenSubreport("RPTHSN.rpt").Database.Tables.COUNT
                ...
                End If
            Next i
            Report.OpenSubreport("RPTHSN.rpt").RecordSelectionFormula = "({TRXFILE.TRX_TYPE}= 'DM' AND {TRXFILE.VCH_NO}= " & Val(txtBillNo.Text) & " )"
...
'            End If
        ...
        For i = 1 To Report.OpenSubreport("RPTBILL1.rpt").Database.Tables.COUNT
            ...
            End If
        Next i
        Report.OpenSubreport("RPTBILL1.rpt").RecordSelectionFormula = "({TRXFILE.TRX_TYPE}= 'DM' AND {TRXFILE.VCH_NO}= " & Val(txtBillNo.Text) & ")"
        ...
        If Val(MDIMAIN.StatusBar.Panels(11).Text) > 1 Then
            For i = 1 To Report.OpenSubreport("RPTBILL2.rpt").Database.Tables.COUNT
                ...
                End If
            Next i
            Report.OpenSubreport("RPTBILL2.rpt").RecordSelectionFormula = "({TRXFILE.TRX_TYPE}= 'DM' AND {TRXFILE.VCH_NO}= " & Val(txtBillNo.Text) & ")"
        ...
        If Val(MDIMAIN.StatusBar.Panels(11).Text) > 2 Then
            For i = 1 To Report.OpenSubreport("RPTBILL3.rpt").Database.Tables.COUNT
                ...
                End If
            Next i
            Report.OpenSubreport("RPTBILL3.rpt").RecordSelectionFormula = "({TRXFILE.TRX_TYPE}= 'DM' AND {TRXFILE.VCH_NO}= " & Val(txtBillNo.Text) & ")"
        ...
        If Val(MDIMAIN.StatusBar.Panels(11).Text) > 3 Then
            For i = 1 To Report.OpenSubreport("RPTBILL4.rpt").Database.Tables.COUNT
                ...
                End If
            Next i
            Report.OpenSubreport("RPTBILL4.rpt").RecordSelectionFormula = "({TRXFILE.TRX_TYPE}= 'DM' AND {TRXFILE.VCH_NO}= " & Val(txtBillNo.Text) & ")"
