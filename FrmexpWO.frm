...
Private Sub CMDADD_Click()
    ...
    RSTTRXFILE.Open "Select MAX(Val(EX_SLNO)) from WAR_LIST", db, adOpenForwardOnly
...
Private Sub Form_Load()
    ...
    ACT_REC.Open "select ACT_CODE, ACT_NAME from [ACTMAST]  WHERE (Mid(ACT_CODE, 1, 3)='311')And (len(ACT_CODE)>3) ORDER BY ACT_NAME", db, adOpenForwardOnly
