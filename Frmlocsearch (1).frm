    ...
    With adoGrid
        ...
        If CHKCATEGORY2.Value = 0 And chkcategory.Value = 0 Then
            If OptStock.Value = True Then
                .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, P_RETAIL, P_WS, P_VAN FROM ITEMMAST WHERE (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF') AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CLOSE_QTY <>0 ORDER BY ITEM_NAME", db, adOpenForwardOnly
            ElseIf OptPC.Value = True Then
                .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, P_RETAIL, P_WS, P_VAN FROM ITEMMAST WHERE (ISNULL(ITEM_MAL) OR ITEM_MAL = '') and (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' ORDER BY ITEM_NAME", db, adOpenForwardOnly
            Else
                .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, P_RETAIL, P_WS, P_VAN FROM ITEMMAST WHERE (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%')) AND ucase(CATEGORY) <> 'SERVICE CHARGE' ORDER BY ITEM_NAME", db, adOpenForwardOnly
            End If
        Else
            If CHKCATEGORY2.Value = 1 Then
                If OptStock.Value = True Then
                    .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, P_RETAIL, P_WS, P_VAN FROM ITEMMAST WHERE (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND MANUFACTURER = '" & DataList1.BoundText & "' AND CLOSE_QTY <>0 ORDER BY ITEM_NAME", db, adOpenForwardOnly
                ElseIf OptPC.Value = True Then
                    .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, P_RETAIL, P_WS, P_VAN FROM ITEMMAST WHERE (ISNULL(ITEM_MAL) OR ITEM_MAL = '') and (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND MANUFACTURER = '" & DataList1.BoundText & "' ORDER BY ITEM_NAME", db, adOpenForwardOnly
                Else
                    .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, P_RETAIL, P_WS, P_VAN FROM ITEMMAST WHERE (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND MANUFACTURER = '" & DataList1.BoundText & "' ORDER BY ITEM_NAME", db, adOpenForwardOnly
                End If
            Else
                If OptStock.Value = True Then
                    .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, P_RETAIL, P_WS, P_VAN FROM ITEMMAST WHERE ucase(CATEGORY) <> 'SELF'  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CATEGORY = '" & DataList1.BoundText & "' AND CLOSE_QTY <>0 ORDER BY ITEM_NAME", db, adOpenForwardOnly
                ElseIf OptPC.Value = True Then
                    .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, P_RETAIL, P_WS, P_VAN FROM ITEMMAST WHERE (ISNULL(ITEM_MAL) OR ITEM_MAL = '') and ucase(CATEGORY) <> 'SELF'  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CATEGORY = '" & DataList1.BoundText & "' ORDER BY ITEM_NAME", db, adOpenForwardOnly
                Else
                    .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, P_RETAIL, P_WS, P_VAN FROM ITEMMAST WHERE ucase(CATEGORY) <> 'SELF'  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CATEGORY = '" & DataList1.BoundText & "' ORDER BY ITEM_NAME", db, adOpenForwardOnly
                End If
...
Private Sub tXTMEDICINE_Change()
    ...
    If REPFLAG = True Then
        If CHKCATEGORY2.Value = 0 Then
            ...
            Else
                RSTREP.Open "Select DISTINCT ITEM_CODE, ITEM_NAME From ITEMMAST  WHERE  ucase(CATEGORY) <> 'SELF'  AND ucase(CATEGORY) <> 'OWN' AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND ucase(CATEGORY) <> 'SERVICES'  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') ORDER BY ITEM_NAME", db, adOpenForwardOnly
            End If
        Else
            If OptStock.Value = True Then
...
Private Function Fillgrid()
    ...
    With adoGrid
        ...
        If CHKCATEGORY2.Value = 0 And chkcategory.Value = 0 Then
            If OptStock.Value = True Then
                .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX FROM ITEMMAST WHERE (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF') AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CLOSE_QTY <>0 ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
            ElseIf OptPC.Value = True Then
                .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX FROM ITEMMAST WHERE PRICE_CHANGE = 'Y' and (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
            Else
                .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX FROM ITEMMAST WHERE (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%')) AND ucase(CATEGORY) <> 'SERVICE CHARGE' ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
            End If
        Else
            If CHKCATEGORY2.Value = 1 Then
                If OptStock.Value = True Then
                    .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX FROM ITEMMAST WHERE (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND MANUFACTURER = '" & DataList1.BoundText & "' AND CLOSE_QTY <>0 ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
                ElseIf OptPC.Value = True Then
                    .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX FROM ITEMMAST WHERE PRICE_CHANGE = 'Y' and (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND MANUFACTURER = '" & DataList1.BoundText & "' ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
                Else
                    .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX FROM ITEMMAST WHERE (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND MANUFACTURER = '" & DataList1.BoundText & "' ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
                End If
            Else
                If OptStock.Value = True Then
                    .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX FROM ITEMMAST WHERE ucase(CATEGORY) <> 'SELF'  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CATEGORY = '" & DataList1.BoundText & "' AND CLOSE_QTY <>0 ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
                ElseIf OptPC.Value = True Then
                    .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX FROM ITEMMAST WHERE PRICE_CHANGE = 'Y' and ucase(CATEGORY) <> 'SELF'  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CATEGORY = '" & DataList1.BoundText & "' ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
                Else
                    .Open "SELECT ITEM_CODE, ITEM_NAME, BIN_LOCATION, ITEM_MAL, CLOSE_QTY, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX FROM ITEMMAST WHERE ucase(CATEGORY) <> 'SELF'  AND ITEM_NAME Like '%" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '%" & Me.TXTITEMCODE.text & "%' AND (ISNULL(ITEM_SPEC) OR ITEM_SPEC Like '%" & Me.txtspecs.text & "%') AND (ISNULL(BIN_LOCATION) OR BIN_LOCATION Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CATEGORY = '" & DataList1.BoundText & "' ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
                End If
