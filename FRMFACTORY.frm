...
'    End If
    ...
    For n = 1 To grdsales.rows - 1
        ...
        Set RSTTRXFILE = New ADODB.Recordset
        RSTTRXFILE.Open "SELECT *  FROM DGTRXFILE WHERE TRX_TYPE = '" & Trim(grdsales.TextMatrix(n, 16)) & "' AND VCH_NO = " & Val(grdsales.TextMatrix(n, 14)) & " AND LINE_NO = " & Val(grdsales.TextMatrix(n, 15)) & "", db, adOpenStatic, adLockOptimistic, adCmdText
        With RSTTRXFILE
            If Not (.EOF And .BOF) Then
...
'    TRXMAST.Open "Select MAX(VCH_NO) From DAMGMAST", db, adOpenForwardOnly
...
Private Sub CMDADD_Click()
    ...
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "SELECT *  FROM DGTRXFILE WHERE ITEM_CODE = '" & grdsales.TextMatrix(Val(TXTSLNO.text), 13) & "' AND TRX_TYPE = '" & Trim(grdsales.TextMatrix(Val(TXTSLNO.text), 16)) & "' AND VCH_NO = " & Val(grdsales.TextMatrix(Val(TXTSLNO.text), 14)) & " AND LINE_NO = " & Val(grdsales.TextMatrix(Val(TXTSLNO.text), 15)) & " AND BAL_QTY > 0", db, adOpenStatic, adLockOptimistic, adCmdText
    With RSTTRXFILE
        If Not (.EOF And .BOF) Then
            If (IsNull(!ISSUE_QTY)) Then !ISSUE_QTY = 0
            If (IsNull(!BAL_QTY)) Then !BAL_QTY = 0
        ...
        Else
            ...
            Set RSTTRXFILE = Nothing
            Set RSTTRXFILE = New ADODB.Recordset
            RSTTRXFILE.Open "SELECT *  FROM DGTRXFILE WHERE ITEM_CODE = '" & grdsales.TextMatrix(Val(TXTSLNO.text), 13) & "' AND BAL_QTY > 0 ORDER BY BAL_QTY DESC", db, adOpenStatic, adLockOptimistic, adCmdText
            If Not (RSTTRXFILE.EOF And RSTTRXFILE.BOF) Then
    ...
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "Select * From DAMGMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='DG' AND VCH_NO = " & Val(txtBillNo.text) & "", db, adOpenStatic, adLockOptimistic, adCmdText
...
Private Sub CmdDelete_Click()
    ...
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "SELECT *  FROM DGTRXFILE WHERE TRX_TYPE = '" & Trim(grdsales.TextMatrix(Val(TXTSLNO.text), 16)) & "' AND VCH_NO = " & Val(grdsales.TextMatrix(Val(TXTSLNO.text), 14)) & " AND LINE_NO = " & Val(grdsales.TextMatrix(Val(TXTSLNO.text), 15)) & "", db, adOpenStatic, adLockOptimistic, adCmdText
    With RSTTRXFILE
        If Not (.EOF And .BOF) Then
            If (IsNull(!ISSUE_QTY)) Then !ISSUE_QTY = 0
            If (IsNull(!BAL_QTY)) Then !BAL_QTY = 0
...
Public Function Generateprint()
    ...
    If OLD_BILL = False Then Call checklastbill
    OLD_BILL = True
    db.Execute "delete From DAMGMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='DG' AND VCH_NO = " & Val(txtBillNo.text) & ""
    db.Execute "delete From TEMPTRXFILE "
    
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "Select * From DAMGMAST ", db, adOpenStatic, adLockOptimistic, adCmdText
    RSTTRXFILE.AddNew
    RSTTRXFILE!VCH_NO = Val(txtBillNo.text)
    RSTTRXFILE!TRX_TYPE = "DG"
    RSTTRXFILE!TRX_YEAR = Year(MDIMAIN.DTFROM.Value)
...
Private Sub Form_Load()
    ...
    rstBILL.Open "Select MAX(VCH_NO) From DAMGMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE = 'DG'", db, adOpenStatic, adLockReadOnly
...
'                        End If
            ...
            RSTBATCH.Open "Select * FROM DGTRXFILE WHERE ITEM_CODE = '" & TXTITEMCODE.text & "' AND LENGTH(REF_NO)>0 AND BAL_QTY >0 ", db, adOpenStatic, adLockReadOnly
...
Private Sub TXTBILLNO_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    Select Case KeyCode
        Case vbKeyReturn
            ...
            TRXSUB.Open "Select * FROM TRXSUB WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='DG' AND VCH_NO = " & Val(txtBillNo.text) & " ORDER BY LINE_NO", db, adOpenStatic, adLockReadOnly
            Do Until TRXSUB.EOF
                Set TRXFILE = New ADODB.Recordset
                TRXFILE.Open "Select * From TRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='DG' AND VCH_NO = " & Val(txtBillNo.text) & " AND LINE_NO = " & Val(TRXSUB!line_no) & "", db, adOpenStatic, adLockReadOnly
                If Not (TRXFILE.EOF And TRXFILE.BOF) Then
                    ...
                    Set TRXMAST = New ADODB.Recordset
                    TRXMAST.Open "SELECT UNIT FROM RTRXFILE WHERE TRX_TYPE = '" & Trim(TRXSUB!R_TRX_TYPE) & "' AND VCH_NO = " & Val(TRXSUB!R_VCH_NO) & " AND LINE_NO = " & Val(TRXSUB!R_LINE_NO) & "", db, adOpenStatic, adLockReadOnly
            ...
            Set TRXMAST = New ADODB.Recordset
            TRXMAST.Open "Select * From DAMGMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='DG' AND VCH_NO = " & Val(txtBillNo.text) & "", db, adOpenStatic, adLockReadOnly
            If Not (TRXMAST.EOF Or TRXMAST.BOF) Then
                ...
                TXTREMARKS.text = IIf(IsNull(TRXMAST!REMARKS), "", TRXMAST!REMARKS)
...
Private Sub txtBillNo_LostFocus()
    ...
    On Error GoTo ErrHand
    Set TRXMAST = New ADODB.Recordset
    TRXMAST.Open "Select MAX(VCH_NO) From DAMGMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE = 'DG'", db, adOpenStatic, adLockReadOnly
    If Not (TRXMAST.EOF And TRXMAST.BOF) Then
...
Private Sub TXTPRODUCT_Change()
        ...
        If PHYFLAG = True Then
            ...
            'PHY.Open "Select ITEM_CODE, ITEM_NAME, CLOSE_QTY, SALES_PRICE, SALES_TAX, UNIT, P_RETAIL, COM_FLAG, COM_PER, COM_AMT, CRTN_PACK, P_CRTN, P_WS, P_VAN, CHECK_FLAG, CATEGORY, LOOSE_PACK, PACK_TYPE, WARRANTY, WARRANTY_TYPE, MRP, BIN_LOCATION  From ITEMMAST  WHERE ITEM_NAME Like '%" & Trim(Me.TXTPRODUCT.Text) & "%' AND ITEM_NAME Like '%" & Trim(Me.TxtName1.Text) & "%' AND ucase(CATEGORY) = 'OWN' ORDER BY ITEM_NAME ", db, adOpenStatic, adLockReadOnly
    ...
    Select Case KeyCode
        ...
        Case vbKeyReturn
            ...
            If UCase(TXTITEMCODE.text) <> "OT" Then
                Set grdtmp.DataSource = Nothing
                If PHYFLAG = True Then
                    PHY.Open "Select ITEM_CODE, ITEM_NAME, CLOSE_QTY, SALES_PRICE, SALES_TAX, UNIT, P_RETAIL, COM_FLAG, COM_PER, COM_AMT, CRTN_PACK, P_CRTN, P_WS, P_VAN, CHECK_FLAG, CATEGORY, LOOSE_PACK, PACK_TYPE, WARRANTY, WARRANTY_TYPE  From ITEMMAST  WHERE ITEM_NAME = '" & Me.TXTPRODUCT.text & "' AND ucase(CATEGORY) = 'OWN' ORDER BY ITEM_NAME ", db, adOpenStatic, adLockReadOnly
                    PHYFLAG = False
                Else
                    PHY.Close
                    PHY.Open "Select ITEM_CODE, ITEM_NAME, CLOSE_QTY, SALES_PRICE, SALES_TAX, UNIT, P_RETAIL, COM_FLAG, COM_PER, COM_AMT, CRTN_PACK, P_CRTN, P_WS, P_VAN, CHECK_FLAG, CATEGORY, LOOSE_PACK, PACK_TYPE, WARRANTY, WARRANTY_TYPE   From ITEMMAST  WHERE ITEM_NAME = '" & Me.TXTPRODUCT.text & "' AND ucase(CATEGORY) = 'OWN' ORDER BY ITEM_NAME ", db, adOpenStatic, adLockReadOnly
...
'                End Select
                ...
                TXTRETAILNOTAX.text = IIf(IsNull(grdtmp.Columns(21)), "", Val(grdtmp.Columns(21)))
...
Function FILL_ITEMGRID()
    ...
    If ITEM_FLAG = True Then
        PHY_ITEM.Open "Select ITEM_CODE, ITEM_NAME, CLOSE_QTY, P_RETAIL, P_WS, P_VAN, P_CRTN, CATEGORY From ITEMMAST  WHERE ITEM_NAME Like '%" & TXTPRODUCT.text & "%' AND ucase(CATEGORY) = 'OWN' ORDER BY ITEM_NAME", db, adOpenStatic, adLockReadOnly
        ITEM_FLAG = False
    Else
        PHY_ITEM.Close
        PHY_ITEM.Open "Select ITEM_CODE, ITEM_NAME, CLOSE_QTY, P_RETAIL, P_WS, P_VAN, P_CRTN, CATEGORY From ITEMMAST  WHERE ITEM_NAME Like '%" & TXTPRODUCT.text & "%' AND ucase(CATEGORY) = 'OWN' ORDER BY ITEM_NAME", db, adOpenStatic, adLockReadOnly
...
Private Function AppendSale()
    ...
    If grdsales.rows = 1 Then
        If OLD_BILL = True Then
            ...
            LASTBILL = 1
            Set rstBILL = New ADODB.Recordset
            rstBILL.Open "Select MAX(VCH_NO) From DAMGMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE = 'DG'", db, adOpenForwardOnly
            If Not (rstBILL.EOF And rstBILL.BOF) Then
...
'    Set RSTITEMMAST = Nothing
    ...
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "Select * FROM TRXSUB WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='DG' AND VCH_NO = " & Val(txtBillNo.text) & "", db, adOpenStatic, adLockOptimistic, adCmdText
...
Private Sub TxtItemcode_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    Select Case KeyCode
        Case vbKeyReturn
            ...
            Set grdtmp.DataSource = Nothing
            If PHYFLAG = True Then
                PHY.Open "Select ITEM_CODE, ITEM_NAME, CLOSE_QTY, SALES_PRICE, SALES_TAX, UNIT, P_RETAIL, COM_FLAG, COM_PER, COM_AMT, CRTN_PACK, P_CRTN, P_WS, P_VAN, CHECK_FLAG, CATEGORY, LOOSE_PACK, PACK_TYPE, WARRANTY, WARRANTY_TYPE, MRP, ITEM_COST  From ITEMMAST  WHERE ITEM_CODE = '" & Me.TXTITEMCODE.text & "' ", db, adOpenStatic, adLockReadOnly
                PHYFLAG = False
            Else
                PHY.Close
                PHY.Open "Select ITEM_CODE, ITEM_NAME, CLOSE_QTY, SALES_PRICE, SALES_TAX, UNIT, P_RETAIL, COM_FLAG, COM_PER, COM_AMT, CRTN_PACK, P_CRTN, P_WS, P_VAN, CHECK_FLAG, CATEGORY, LOOSE_PACK, PACK_TYPE, WARRANTY, WARRANTY_TYPE, MRP, ITEM_COST  From ITEMMAST  WHERE ITEM_CODE = '" & Me.TXTITEMCODE.text & "' ", db, adOpenStatic, adLockReadOnly
            ...
            If PHY.RecordCount = 1 Then
                ...
                txtPrintname.text = grdtmp.Columns(1)
                TxtMRP.text = IIf(IsNull(grdtmp.Columns(20)), "", grdtmp.Columns(20))
                TXTRETAILNOTAX.text = IIf(IsNull(grdtmp.Columns(21)), "", grdtmp.Columns(21))
                Set RSTBATCH = New ADODB.Recordset
                RSTBATCH.Open "Select * From RTRXFILE WHERE ITEM_CODE = '" & TXTITEMCODE.text & "' AND LENGTH(REF_NO)>0 AND BAL_QTY >0 ", db, adOpenStatic, adLockReadOnly
                If Not (RSTBATCH.EOF Or RSTBATCH.BOF) Then
                    Call FILL_BATCHGRID
