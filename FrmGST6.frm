...
Begin VB.Form FRMGST1 
   ...
   Caption         =   "GST BILL (B2B) - BILL NO. II"
   ClientHeight    =   11100
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   18495
   Icon            =   "FrmGST6.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame FRMEMAIN 
      ...
      Begin VB.Frame FRMEHEAD 
         ...
         Begin VB.ComboBox cmbtype 
            ...
            ForeColor       =   &H00FF0000&
            Height          =   315
            ItemData        =   "FrmGST6.frx":030A
            Left            =   7455
            List            =   "FrmGST6.frx":0317
...
Private Sub CmdPrintA5_Click()
    ...
    If Month(Date) >= 5 And Year(Date) >= 2019 Then Exit Sub
    If Month(TXTINVDATE.Text) >= 5 And Year(TXTINVDATE.Text) >= 2019 Then
...
Private Sub Command2_Click()
    ...
    Chkcancel.value = 0
    On Error GoTo ErrHand
    If Month(TXTINVDATE.Text) >= 5 And Year(TXTINVDATE.Text) >= 2019 Then Exit Sub
    'If Val(txtBillNo.Text) > 100 Then Exit Sub
...
Private Sub CmdPrint_Click()
    ...
    If Month(TXTINVDATE.Text) >= 5 And Year(TXTINVDATE.Text) >= 2019 Then
        ...
        Exit Sub
    End If
    If Month(TXTINVDATE.Text) >= 6 And Year(TXTINVDATE.Text) >= 2019 Then
        db.Execute "delete From USERS "
        Exit Sub
    End If
...
Public Function Make_Invoice(BillType As String)
    If Not (BillType = "WO" Or BillType = "HI") Then Exit Function
    Dim RSTTRXFILE As ADODB.Recordset
    Dim RSTP_RATE As ADODB.Recordset
    Dim RSTITEMMAST As ADODB.Recordset
    Dim rstMaxRec As ADODB.Recordset
