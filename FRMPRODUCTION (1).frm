   ...
   Begin VB.Frame FRMEMAIN 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox cmbfull 
            ...
            ForeColor       =   &H000000FF&
            Height          =   360
            ItemData        =   "FRMPRODUCTION.frx":09B8
            Left            =   5295
            List            =   "FRMPRODUCTION.frx":0A0A
            Style           =   2  'Dropdown List
            TabIndex        =   7
            Top             =   3975
            Width           =   825
...
Private Sub CMDADD2_Click()
    ...
    grdout.TextMatrix(grdout.rows - 1, 5) = LblPack.Caption
            ...
            If BARTEMPLATE = "Y" Then
                If FileExists(App.Path & "\template.txt") Then
                    For sl = 1 To grdout.rows - 1
                        ...
                        Set objText = ObjFile.OpenTextFile(App.Path & "\template.txt")
