...
Private Sub Form_Load()
    ...
    rstBILL.Open "Select MAX(Val(VCH_NO)) From DAMAGED", db2, adOpenStatic, adLockReadOnly
...
Dim chkflag As Integer
    ...
    Select Case KeyCode
        Case vbKeyReturn
            ...
            TRXSUB.Open "Select * From DAMAGED WHERE VCH_NO = " & Val(txtBillNo.Text) & " ORDER BY LINE_NO", db2, adOpenStatic, adLockReadOnly
            Do Until TRXSUB.EOF
                    I = I + 1
                    grdsales.Rows = grdsales.Rows + 1
                    grdsales.FixedRows = 1
...
Private Sub txtBillNo_LostFocus()
    ...
    TRXDN.Open "Select MAX(Val(VCH_NO)) From DAMAGED", db2, adOpenStatic, adLockReadOnly
...
Public Function AppendSale()
    ...
    I = 0
    On Error GoTo eRRhAND
    db2.Execute "delete * From DAMAGED WHERE VCH_NO = " & Val(txtBillNo.Text) & ""
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "Select * From DAMAGED", db2, adOpenStatic, adLockOptimistic, adCmdText
    For I = 1 To grdsales.Rows - 1
        RSTTRXFILE.AddNew
    ...
    db2.Execute "delete * From TRXFILE WHERE TRX_TYPE='DG' AND VCH_NO = " & Val(txtBillNo.Text) & ""
    Set RSTTRXFILE = New ADODB.Recordset
    ...
    txtBillNo.Text = 1
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "Select MAX(Val(VCH_NO)) From DAMAGED", db2, adOpenStatic, adLockReadOnly
    If Not (RSTTRXFILE.EOF And RSTTRXFILE.BOF) Then
