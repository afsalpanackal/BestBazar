...
Begin VB.Form FRMTRNXREGWO 
   ...
   Begin VB.Frame FRMEMAIN 
      ...
      Begin VB.ComboBox CmbPend 
         ...
         EndProperty
         Height          =   405
         ItemData        =   "FrmTrnxRegwo.frx":000C
         Left            =   12255
         List            =   "FrmTrnxRegwo.frx":0016
      ...
      Begin vbalProgBarLib6.vbalProgressBar vbalProgressBar1 
         ...
         _ExtentX        =   10372
         _ExtentY        =   582
         Picture         =   "FrmTrnxRegwo.frx":002B
         ForeColor       =   0
         BarPicture      =   "FrmTrnxRegwo.frx":0047
         Max             =   150
         Text            =   "PLEASE WAIT..."
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Tahoma"
   ...
   End
End
Attribute VB_Name = "FRMTRNXREGWO"
...
Private Sub CmbPend_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    Select Case KeyCode
        Case vbKeyReturn
            ...
            rststock.Open "SELECT * FROM CASHATRXFILE WHERE  TRX_TYPE = '" & GRDTranx.TextMatrix(GRDTranx.Row, 9) & "' AND REC_NO = " & GRDTranx.TextMatrix(GRDTranx.Row, 10) & " AND INV_TYPE = '" & GRDTranx.TextMatrix(GRDTranx.Row, 11) & "' AND INV_NO = " & GRDTranx.TextMatrix(GRDTranx.Row, 12) & "", db2, adOpenStatic, adLockOptimistic, adCmdText
...
Private Sub CMDDISPLAY_Click()
    ...
    If OPTPERIOD.Value = True Then
       rstTRANX.Open "SELECT * From CASHATRXFILE WHERE [VCH_DATE] <=# " & Format(DTTO.Value, "MM/DD/YYYY") & " # AND [VCH_DATE] >=# " & Format(DTFROM.Value, "MM/DD/YYYY") & " # ORDER BY VCH_DATE,REC_NO", db2, adOpenStatic, adLockReadOnly
    Else
        rstTRANX.Open "SELECT * From CASHATRXFILE WHERE [ACT_CODE] = '" & DataList2.BoundText & "' AND [VCH_DATE] <=# " & Format(DTTO.Value, "MM/DD/YYYY") & " # AND [VCH_DATE] >=# " & Format(DTFROM.Value, "MM/DD/YYYY") & " # ", db2, adOpenStatic, adLockReadOnly
    End If
    ...
    If OPTPERIOD.Value = True Then
        If OptRcpts.Value = True Then
            If optpend.Value = True Then
                rstTRANX.Open "SELECT * From CASHATRXFILE WHERE CASH_MODE ='B' AND CHQ_STATUS = 'N' AND INV_TYPE = 'RT' AND [VCH_DATE] <=# " & Format(DTTO.Value, "MM/DD/YYYY") & " # AND [VCH_DATE] >=# " & Format(DTFROM.Value, "MM/DD/YYYY") & " # ORDER BY VCH_DATE,REC_NO", db2, adOpenStatic, adLockReadOnly
            Else
                rstTRANX.Open "SELECT * From CASHATRXFILE WHERE INV_TYPE = 'RT' AND [VCH_DATE] <=# " & Format(DTTO.Value, "MM/DD/YYYY") & " # AND [VCH_DATE] >=# " & Format(DTFROM.Value, "MM/DD/YYYY") & " # ORDER BY VCH_DATE,REC_NO", db2, adOpenStatic, adLockReadOnly
            End If
        End If
        If OptPymnt.Value = True Then
            If optpend.Value = True Then
                rstTRANX.Open "SELECT * From CASHATRXFILE WHERE CASH_MODE ='B' AND CHQ_STATUS = 'N' AND INV_TYPE = 'PY' AND [VCH_DATE] <=# " & Format(DTTO.Value, "MM/DD/YYYY") & " # AND [VCH_DATE] >=# " & Format(DTFROM.Value, "MM/DD/YYYY") & " # ORDER BY VCH_DATE,REC_NO", db2, adOpenStatic, adLockReadOnly
            Else
                rstTRANX.Open "SELECT * From CASHATRXFILE WHERE INV_TYPE = 'PY' AND [VCH_DATE] <=# " & Format(DTTO.Value, "MM/DD/YYYY") & " # AND [VCH_DATE] >=# " & Format(DTFROM.Value, "MM/DD/YYYY") & " # ORDER BY VCH_DATE,REC_NO", db2, adOpenStatic, adLockReadOnly
            End If
        End If
        If OptBoth.Value = True Then
            If optpend.Value = True Then
                rstTRANX.Open "SELECT * From CASHATRXFILE WHERE CASH_MODE ='B' AND CHQ_STATUS = 'N' AND [VCH_DATE] <=# " & Format(DTTO.Value, "MM/DD/YYYY") & " # AND [VCH_DATE] >=# " & Format(DTFROM.Value, "MM/DD/YYYY") & " # ORDER BY VCH_DATE,REC_NO", db2, adOpenStatic, adLockReadOnly
            Else
                rstTRANX.Open "SELECT * From CASHATRXFILE WHERE [VCH_DATE] <=# " & Format(DTTO.Value, "MM/DD/YYYY") & " # AND [VCH_DATE] >=# " & Format(DTFROM.Value, "MM/DD/YYYY") & " # ORDER BY VCH_DATE,REC_NO", db2, adOpenStatic, adLockReadOnly
            End If
        End If
    Else
        If OptRcpts.Value = True Then
            If optpend.Value = True Then
                If OptRcpts.Value = True Then rstTRANX.Open "SELECT * From CASHATRXFILE WHERE CASH_MODE ='B' AND CHQ_STATUS = 'N' AND INV_TYPE = 'RT' AND [ACT_CODE] = '" & DataList2.BoundText & "' AND [VCH_DATE] <=# " & Format(DTTO.Value, "MM/DD/YYYY") & " # AND [VCH_DATE] >=# " & Format(DTFROM.Value, "MM/DD/YYYY") & " # ORDER BY VCH_DATE,REC_NO", db2, adOpenStatic, adLockReadOnly
            Else
                If OptRcpts.Value = True Then rstTRANX.Open "SELECT * From CASHATRXFILE WHERE INV_TYPE = 'RT' AND [ACT_CODE] = '" & DataList2.BoundText & "' AND [VCH_DATE] <=# " & Format(DTTO.Value, "MM/DD/YYYY") & " # AND [VCH_DATE] >=# " & Format(DTFROM.Value, "MM/DD/YYYY") & " # ORDER BY VCH_DATE,REC_NO", db2, adOpenStatic, adLockReadOnly
            End If
        End If
        If OptPymnt.Value = True Then
            If optpend.Value = True Then
                If OptRcpts.Value = True Then rstTRANX.Open "SELECT * From CASHATRXFILE WHERE CASH_MODE ='B' AND CHQ_STATUS = 'N' AND INV_TYPE = 'PY' AND [ACT_CODE] = '" & DataList2.BoundText & "' AND [VCH_DATE] <=# " & Format(DTTO.Value, "MM/DD/YYYY") & " # AND [VCH_DATE] >=# " & Format(DTFROM.Value, "MM/DD/YYYY") & " # ORDER BY VCH_DATE,REC_NO", db2, adOpenStatic, adLockReadOnly
            Else
                If OptRcpts.Value = True Then rstTRANX.Open "SELECT * From CASHATRXFILE WHERE INV_TYPE = 'PY' AND [ACT_CODE] = '" & DataList2.BoundText & "' AND [VCH_DATE] <=# " & Format(DTTO.Value, "MM/DD/YYYY") & " # AND [VCH_DATE] >=# " & Format(DTFROM.Value, "MM/DD/YYYY") & " # ORDER BY VCH_DATE,REC_NO", db2, adOpenStatic, adLockReadOnly
            End If
        End If
        If OptBoth.Value = True Then
            If optpend.Value = True Then
                If OptRcpts.Value = True Then rstTRANX.Open "SELECT * From CASHATRXFILE WHERE CASH_MODE ='B' AND CHQ_STATUS = 'N' AND [ACT_CODE] = '" & DataList2.BoundText & "' AND [VCH_DATE] <=# " & Format(DTTO.Value, "MM/DD/YYYY") & " # AND [VCH_DATE] >=# " & Format(DTFROM.Value, "MM/DD/YYYY") & " # ORDER BY VCH_DATE,REC_NO", db2, adOpenStatic, adLockReadOnly
            Else
                If OptRcpts.Value = True Then rstTRANX.Open "SELECT * From CASHATRXFILE WHERE [ACT_CODE] = '" & DataList2.BoundText & "' AND [VCH_DATE] <=# " & Format(DTTO.Value, "MM/DD/YYYY") & " # AND [VCH_DATE] >=# " & Format(DTFROM.Value, "MM/DD/YYYY") & " # ORDER BY VCH_DATE,REC_NO", db2, adOpenStatic, adLockReadOnly
            End If
        End If
    End If
...
Private Sub TXTDEALER_Change()
    ...
    If flagchange.Caption <> "1" Then
        If ACT_FLAG = True Then
            ACT_REC.Open "select ACT_CODE, ACT_NAME from [ACTMAST]  WHERE ((Mid(ACT_CODE, 1, 3)='311' And (len(ACT_CODE)>3))or (Mid(ACT_CODE, 1, 2)='13' And (len(ACT_CODE)>2))) And ACT_NAME Like '" & Me.TXTDEALER.Text & "%'ORDER BY ACT_NAME", db2, adOpenStatic, adLockReadOnly
            ACT_FLAG = False
        Else
            ACT_REC.Close
            ACT_REC.Open "select ACT_CODE, ACT_NAME from [ACTMAST]  WHERE ((Mid(ACT_CODE, 1, 3)='311' And (len(ACT_CODE)>3))or (Mid(ACT_CODE, 1, 2)='13' And (len(ACT_CODE)>2))) And ACT_NAME Like '" & Me.TXTDEALER.Text & "%'ORDER BY ACT_NAME", db2, adOpenStatic, adLockReadOnly
