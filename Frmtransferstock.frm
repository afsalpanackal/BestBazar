...
Begin VB.Form FRMTRANSFER 
   ...
   ClientTop       =   435
   ClientWidth     =   18495
   Icon            =   "Frmtransferstock.frx":0000
   KeyPreview      =   -1  'True
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame FRMEMAIN 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.PictureBox picUnchecked 
            Height          =   285
            Left            =   16080
            Picture         =   "Frmtransferstock.frx":030A
            ScaleHeight     =   225
            ScaleWidth      =   225
            TabIndex        =   144
            Top             =   3105
         ...
         Begin VB.PictureBox picChecked 
            Height          =   285
            Left            =   15435
            Picture         =   "Frmtransferstock.frx":064C
            ScaleHeight     =   225
            ScaleWidth      =   225
            TabIndex        =   143
            Top             =   3075
...
'    RSTTRXFILE.Open "SELECT *  FROM TEMPCN WHERE ACT_CODE = '" & Trim(DataList2.BoundText) & "' AND BILL_NO = " & Val(txtBillNo.Text) & " AND BILL_TRX_TYPE = 'TF' AND TRX_TYPE = 'TF'", db, adOpenStatic, adLockOptimistic, adCmdText
...
'    Set RSTTRXFILE = Nothing
    ...
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "SELECT *  FROM RTRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(TxtCN.Text) & "", db, adOpenStatic, adLockReadOnly, adCmdText
    With RSTTRXFILE
        Do Until .EOF
    ...
    RSTTRXFILE.Close
    Set RSTTRXFILE = Nothing
    db.Execute "delete From RTRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(TxtCN.Text) & ""
    ...
    For n = 1 To grdsales.rows - 1
        ...
        If grdsales.TextMatrix(n, 19) = "DN" Then
            Set RSTTRXFILE = New ADODB.Recordset
            'RSTTRXFILE.Open "SELECT *  FROM TEMPCN WHERE ACT_CODE = '" & Trim(DataList2.BoundText) & "' AND TRX_TYPE = 'TF' AND VCH_NO = " & Val(grdsales.TextMatrix(n, 35)) & " AND LINE_NO = " & Val(grdsales.TextMatrix(n, 37)) & " ", db, adOpenStatic, adLockOptimistic, adCmdText
...
'    End If
    ...
    If IsNull(DataList2.SelectedItem) Then
        MsgBox "Select the Branch From List", vbOKOnly, "STOCK TRANSFER"
        FRMEHEAD.Enabled = True
        DataList2.SetFocus
        Exit Sub
    End If
...
'    oWS.Range("I:I").ColumnWidth = 12
    ...
    For n = 1 To grdsales.rows - 1
        ...
        oWS.Range("M" & i).Value = grdsales.TextMatrix(n, 8)
    ...
    oApp.Columns("A:M").EntireColumn.AutoFit     '-- autofitted column
...
Public Sub DataList2_Click()
    ...
    lblsubdealer = ""
    Set rstCustomer = New ADODB.Recordset
    rstCustomer.Open "Select * From ACTMAST WHERE ACT_CODE = '" & DataList2.BoundText & "'", db, adOpenStatic, adLockReadOnly
    If Not (rstCustomer.EOF And rstCustomer.BOF) Then
...
'    End If
    ...
    If OLD_BILL = False And Val(txtBillNo.Text) <> 1 And grdsales.rows <= 1 Then
        RSTTRXFILE.Open "Select * From TRXMAST WHERE VCH_NO= (SELECT MAX(VCH_NO) FROM TRXMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE = 'TF')", db, adOpenStatic, adLockPessimistic, adCmdText
    ...
    Else
        LBLBILLNO.Caption = Val(txtBillNo.Text)
        RSTTRXFILE.Open "Select * FROM TRXMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & "", db, adOpenStatic, adLockPessimistic, adCmdText
...
Private Sub CmdDelivery_Click()
    ...
    If OLD_BILL = False Then
        Dim TRXMAST As ADODB.Recordset
        Set TRXMAST = New ADODB.Recordset
        TRXMAST.Open "Select MAX(VCH_NO) From TRXMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE = 'TF'", db, adOpenForwardOnly
        If Not (TRXMAST.EOF And TRXMAST.BOF) Then
...
'        db.BeginTrans
    ...
    For n = 0 To grdcount.rows - 1
        ...
        Set RSTTRXFILE = New ADODB.Recordset
        RSTTRXFILE.Open "Select * FROM TRXSUB WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(grdsales.rows - 1, 32)) & "", db, adOpenStatic, adLockOptimistic, adCmdText
        If (RSTTRXFILE.EOF And RSTTRXFILE.BOF) Then
            RSTTRXFILE.AddNew
            RSTTRXFILE!VCH_NO = Val(txtBillNo.Text)
            RSTTRXFILE!TRX_TYPE = "TF"
        ...
        Set RSTTRXFILE = New ADODB.Recordset
        RSTTRXFILE.Open "Select * FROM TRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(grdsales.rows - 1, 32)) & "", db, adOpenStatic, adLockOptimistic, adCmdText
        If (RSTTRXFILE.EOF And RSTTRXFILE.BOF) Then
            RSTTRXFILE.AddNew
            RSTTRXFILE!TRX_TYPE = "TF"
            RSTTRXFILE!TRX_YEAR = Year(MDIMAIN.DTFROM.Value)
...
'    End If
    ...
    RSTCOMPANY.Open "SELECT * FROM TRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & "", db, adOpenForwardOnly
...
Private Sub Form_Load()
    ...
    If Not (RSTCOMPANY.EOF And RSTCOMPANY.BOF) Then
        lblpre.Caption = IIf(IsNull(RSTCOMPANY!PREFIX_TR), "", RSTCOMPANY!PREFIX_TR)
        lblsuf.Caption = IIf(IsNull(RSTCOMPANY!SUFIX_TR), "", RSTCOMPANY!SUFIX_TR)
...
'    End If
    ...
    TXTAREA.Clear
    Set rstBILL = New ADODB.Recordset
    rstBILL.Open "Select DISTINCT AREA From ACTMAST ORDER BY AREA", db, adOpenForwardOnly
...
Private Sub grdsales_DblClick()
    ...
    End If
    On Error GoTo ERRHAND
    db.Execute "Update TRXFILE set UN_BILL = '" & Trim(grdsales.TextMatrix(grdsales.Row, 46)) & "' WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(grdsales.Row, 32)) & ""
    Exit Sub
ERRHAND:
    MsgBox err.Description
End Sub
...
'            Set TRXMAST = Nothing
            ...
            TRXFILE.Open "Select * From TRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & " ORDER BY LINE_NO", db, adOpenStatic, adLockReadOnly
...
'                Set TRXMAST = Nothing
                ...
                TRXSUB.Open "Select * FROM TRXSUB WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & " AND LINE_NO = " & Val(TRXFILE!LINE_NO) & "", db, adOpenStatic, adLockReadOnly
...
'                    rstBILL.Open "Select * From TRXMAST WHERE VCH_NO= (SELECT MAX(VCH_NO) FROM TRXMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE = 'TF')", db, adOpenStatic, adLockPessimistic, adCmdText
...
'                Else
'                    rstBILL.Open "Select * FROM TRXMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & "", db, adOpenStatic, adLockPessimistic, adCmdText
...
Function FILL_PREVIIOUSRATE()
    ...
    If PRERATE_FLAG = True Then
        PHY_PRERATE.Open "Select ITEM_CODE, VCH_DESC, VCH_DATE, QTY, P_RETAIL, M_USER_ID, VCH_NO, ITEM_NAME  From TRXFILE  WHERE TRX_TYPE ='TF' AND ITEM_CODE = '" & TXTITEMCODE.Text & "' AND M_USER_ID = '" & DataList2.BoundText & "' AND VCH_NO <> " & Val(txtBillNo.Text) & " ORDER BY VCH_DATE DESC", db, adOpenStatic, adLockReadOnly
        PRERATE_FLAG = False
    Else
        PHY_PRERATE.Close
        PHY_PRERATE.Open "Select ITEM_CODE, VCH_DESC, VCH_DATE, QTY, P_RETAIL, M_USER_ID, VCH_NO, ITEM_NAME  From TRXFILE  WHERE TRX_TYPE ='TF' AND ITEM_CODE = '" & TXTITEMCODE.Text & "' AND M_USER_ID = '" & DataList2.BoundText & "' AND VCH_NO <> " & Val(txtBillNo.Text) & " ORDER BY VCH_DATE DESC", db, adOpenStatic, adLockReadOnly
...
Function FILL_PREVIIOUSRATE2()
    ...
    If PRERATE_FLAG = True Then
        'PHY_PRERATE.Open "Select TOP 10 ITEM_CODE, VCH_DESC, VCH_DATE, QTY, P_RETAIL, M_USER_ID, VCH_NO, ITEM_NAME  From TRXFILE  WHERE TRX_TYPE ='TF' AND ITEM_CODE = '" & TXTITEMCODE.Text & "' AND M_USER_ID = '" & DataList2.BoundText & "' AND VCH_NO <> " & Val(txtBillNo.Text) & " ORDER BY VCH_DATE DESC", db, adOpenStatic, adLockReadOnly
...
'    Print #1, Chr(27) & Chr(48) & Chr(27) & Chr(106) & Chr(216) & Chr(27) & _
    ...
    RSTCOMPANY.Open "SELECT * FROM COMPINFO WHERE COMP_CODE = '001' AND FIN_YR = '" & Year(MDIMAIN.DTFROM.Value) & "'", db, adOpenStatic, adLockReadOnly
    If Not (RSTCOMPANY.EOF And RSTCOMPANY.BOF) Then
        BIL_PRE = IIf(IsNull(RSTCOMPANY!PREFIX_TR), "", RSTCOMPANY!PREFIX_TR)
        BILL_SUF = IIf(IsNull(RSTCOMPANY!SUFIX_TR), "", RSTCOMPANY!SUFIX_TR)
...
'    End If
    ...
    Dim RSTtax As ADODB.Recordset
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "SELECT DISTINCT SALES_TAX From TRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & " AND SALES_TAX > 0 order by SALES_TAX", db, adOpenStatic, adLockReadOnly
    Do Until RSTTRXFILE.EOF
        TaxAmt = 0
        taxableamt = 0
        Set RSTtax = New ADODB.Recordset
        RSTtax.Open "Select * From TRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND SALES_TAX = " & RSTTRXFILE!SALES_TAX & " AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & "", db, adOpenStatic, adLockReadOnly, adCmdText
        Do Until RSTtax.EOF
        ...
        Case vbKeyReturn
            Select Case grdsales.Col
                ...
                Case 3 'Qty
                    ...
                    db.Execute "Update TRXFILE set QTY = " & Val(grdsales.TextMatrix(grdsales.Row, 3)) & ", TRX_TOTAL = " & Val(grdsales.TextMatrix(grdsales.Row, 12)) & ", SCHEME = " & Val(TXTDISC.Tag) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(grdsales.Row, 32)) & ""
                    db.Execute "Update TRXMAST set COMM_AMT = 0, PAY_AMOUNT = " & Val(LBLTOTALCOST.Caption) & ", ADD_AMOUNT = " & Val(LBLRETAMT.Caption) & ", DISCOUNT = " & Val(TXTTOTALDISC.Text) & ", DISC_PERS  = " & Val(TXTTOTALDISC.Text) & ", VCH_AMOUNT = " & Val(LBLTOTAL.Caption) & ", NET_AMOUNT = " & Val(lblnetamount.Caption) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & ""
                    db.Execute "COMMIT"
                ...
                Case 5  'MRP
                    ...
                    db.Execute "START TRANSACTION"
                    db.Execute "Update TRXFILE set MRP = " & Val(grdsales.TextMatrix(grdsales.Row, 5)) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(grdsales.Row, 32)) & ""
                    db.Execute "COMMIT"
                    grdsales.Enabled = True
                    TXTsample.Visible = False
                    grdsales.SetFocus
                ...
                Case 8  'Disc
                    ...
                    db.Execute "START TRANSACTION"
                    db.Execute "Update TRXFILE set LINE_DISC = " & Val(grdsales.TextMatrix(grdsales.Row, 8)) & ", TRX_TOTAL = " & Val(grdsales.TextMatrix(grdsales.Row, 12)) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(grdsales.Row, 32)) & ""
                    db.Execute "Update TRXMAST set COMM_AMT = 0, PAY_AMOUNT = " & Val(LBLTOTALCOST.Caption) & ", ADD_AMOUNT = " & Val(LBLRETAMT.Caption) & ", DISCOUNT = " & Val(TXTTOTALDISC.Text) & ", DISC_PERS  = " & Val(TXTTOTALDISC.Text) & ", VCH_AMOUNT = " & Val(LBLTOTAL.Caption) & ", NET_AMOUNT = " & Val(lblnetamount.Caption) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & ""
                    db.Execute "COMMIT"
                    grdsales.Enabled = True
                    TXTsample.Visible = False
                ...
                Case 24  'Commission
                    ...
                    db.Execute "START TRANSACTION"
                    db.Execute "Update TRXFILE set COM_AMT = " & Val(grdsales.TextMatrix(grdsales.Row, 24)) & "  WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(grdsales.Row, 32)) & ""
                    db.Execute "Update TRXMAST set COMM_AMT = " & Val(lblcomamt.Text) & ", PAY_AMOUNT = " & Val(LBLTOTALCOST.Caption) & ", ADD_AMOUNT = " & Val(LBLRETAMT.Caption) & ", DISCOUNT = " & Val(TXTTOTALDISC.Text) & ", DISC_PERS  = " & Val(TXTTOTALDISC.Text) & ", VCH_AMOUNT = " & Val(LBLTOTAL.Caption) & ", NET_AMOUNT = " & Val(lblnetamount.Caption) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & ""
...
'    Set RSTTRXFILE = New ADODB.Recordset
'    If OLD_BILL = False And Val(txtBillNo.Text) <> 1 Then
'        RSTTRXFILE.Open "Select * From TRXMAST WHERE VCH_NO= (SELECT MAX(VCH_NO) FROM TRXMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE = 'TF')", db, adOpenStatic, adLockOptimistic, adCmdText
'        db.Execute "Lock tables TRXMAST write"
'        txtBillNo.Text = RSTTRXFILE!VCH_NO + 1
'        LBLBILLNO.Caption = Val(txtBillNo.Text)
'        db.BeginTrans
...
SKIP_UNBILL:
    ...
    Do Until rstTRXMAST.EOF
        ...
        Set RSTITEMMAST = New ADODB.Recordset
        RSTITEMMAST.Open "SELECT * FROM ITEMMAST WHERE ITEM_CODE = '" & rstTRXMAST!ITEM_CODE & "'", db, adOpenStatic, adLockReadOnly
        If Not (RSTITEMMAST.EOF And RSTITEMMAST.BOF) Then
            RSTTRXFILE!C_USER_ID = IIf(IsNull(RSTITEMMAST!REMARKS), "", Left(RSTITEMMAST!REMARKS, 8))
            RSTTRXFILE!MFGR = IIf(IsNull(RSTITEMMAST!ITEM_MAL), "", RSTITEMMAST!ITEM_MAL)
            RSTTRXFILE!M_USER_ID = IIf(IsNull(RSTITEMMAST!FULL_PACK), RSTTRXFILE!PACK_TYPE, RSTITEMMAST!FULL_PACK)
    ...
    Taxsplit = ""
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "SELECT DISTINCT SALES_TAX From TEMPTRXFILE WHERE TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & " order by SALES_TAX", db, adOpenStatic, adLockReadOnly
    Do Until RSTTRXFILE.EOF
        TaxAmt = 0
        taxableamt = 0
        Set RSTtax = New ADODB.Recordset
        RSTtax.Open "Select * From TEMPTRXFILE WHERE SALES_TAX = " & RSTTRXFILE!SALES_TAX & " AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & "", db, adOpenStatic, adLockReadOnly, adCmdText
        Do Until RSTtax.EOF
            If OPTDISCPERCENT.Value = True Then
                grdtmp.Tag = (RSTtax!PTR - (RSTtax!PTR * RSTtax!LINE_DISC) / 100) - ((RSTtax!PTR - (RSTtax!PTR * RSTtax!LINE_DISC) / 100) * Val(TXTTOTALDISC.Text) / 100)
            Else
...
'    End If
    ...
    If Val(MDIMAIN.LBLTRCopy.Caption) = 1 Then
        If Small_Print = True Then
            'ReportNameVar = Rptpath & "rptbillretail"
            ReportNameVar = Rptpath & "RPTGSTBILLTRA51"
        Else
            ReportNameVar = Rptpath & "RPTGSTBILLTR1"
        End If
        ...
        If Val(lblnetamount.Caption) >= Val(MDIMAIN.LBLHSNSUM.Caption) Or Trim(lblIGST.Caption) = "Y" Then
            For i = 1 To Report.OpenSubreport("RPTHSN.rpt").Database.Tables.COUNT
                ...
                End If
            Next i
            Report.OpenSubreport("RPTHSN.rpt").RecordSelectionFormula = "({TRXFILE.VCH_NO}= " & Val(txtBillNo.Text) & " and ({TRXFILE.TRX_TYPE}= 'TF' or {TRXFILE.TRX_TYPE}= 'XC'))"
        ...
        Report.RecordSelectionFormula = "({TRXFILE.VCH_NO}= " & Val(txtBillNo.Text) & " and ({TRXFILE.TRX_TYPE}= 'TF' or {TRXFILE.TRX_TYPE}= 'XC'))"
    ...
    Else
        If Trim(lblIGST.Caption) <> "Y" Then
            ...
            If Small_Print = True Then
                'ReportNameVar = Rptpath & "rptbillretail"
                ReportNameVar = Rptpath & "RPTGSTBILLTRA5"
            Else
                ReportNameVar = Rptpath & "rptGSTBILLTR"
            End If
...
'            End If
        Else
            ReportNameVar = Rptpath & "RPTGSTWBILLTR"
        End If
        If Val(MDIMAIN.LBLTRCopy.Caption) > 4 Then MDIMAIN.LBLTRCopy.Caption = 4
        Set Report = crxApplication.OpenReport(ReportNameVar, 1)
        ...
        Set CRXFormulaFields = Report.FormulaFields
        For Each CRXFormulaField In CRXFormulaFields
            If CRXFormulaField.Name = "{@Copies}" Then CRXFormulaField.Text = " " & Val(MDIMAIN.LBLTRCopy.Caption) & " "
        Next
        For i = 1 To Report.OpenSubreport("RPTBILL1.rpt").Database.Tables.COUNT
            ...
            End If
        Next i
        Report.OpenSubreport("RPTBILL1.rpt").RecordSelectionFormula = "({TRXFILE.VCH_NO}= " & Val(txtBillNo.Text) & " and ({TRXFILE.TRX_TYPE}= 'TF' or {TRXFILE.TRX_TYPE}= 'XC'))"
        ...
        If Val(MDIMAIN.LBLTRCopy.Caption) > 1 Then
            For i = 1 To Report.OpenSubreport("RPTBILL2.rpt").Database.Tables.COUNT
                ...
                End If
            Next i
            Report.OpenSubreport("RPTBILL2.rpt").RecordSelectionFormula = "({TRXFILE.VCH_NO}= " & Val(txtBillNo.Text) & " and ({TRXFILE.TRX_TYPE}= 'TF' or {TRXFILE.TRX_TYPE}= 'XC'))"
            Report.OpenSubreport("RPTBILL2.rpt").DiscardSavedData
            Report.OpenSubreport("RPTBILL2.rpt").VerifyOnEveryPrint = True
        End If
        
        If Val(MDIMAIN.LBLTRCopy.Caption) > 2 Then
            For i = 1 To Report.OpenSubreport("RPTBILL3.rpt").Database.Tables.COUNT
                ...
                End If
            Next i
            Report.OpenSubreport("RPTBILL3.rpt").RecordSelectionFormula = "({TRXFILE.VCH_NO}= " & Val(txtBillNo.Text) & " and ({TRXFILE.TRX_TYPE}= 'TF' or {TRXFILE.TRX_TYPE}= 'XC'))"
            Report.OpenSubreport("RPTBILL3.rpt").DiscardSavedData
            Report.OpenSubreport("RPTBILL3.rpt").VerifyOnEveryPrint = True
        End If
        If Val(MDIMAIN.LBLTRCopy.Caption) > 3 Then
            For i = 1 To Report.OpenSubreport("RPTBILL4.rpt").Database.Tables.COUNT
                ...
                End If
            Next i
            Report.OpenSubreport("RPTBILL4.rpt").RecordSelectionFormula = "({TRXFILE.VCH_NO}= " & Val(txtBillNo.Text) & " and ({TRXFILE.TRX_TYPE}= 'TF' or {TRXFILE.TRX_TYPE}= 'XC'))"
            Report.OpenSubreport("RPTBILL4.rpt").DiscardSavedData
            Report.OpenSubreport("RPTBILL4.rpt").VerifyOnEveryPrint = True
        End If
        For i = 1 To Val(MDIMAIN.LBLTRCopy.Caption)
            'Set CRXFormulaFields = Report.FormulaFields
    ...
    Select Case KeyCode
        Case vbKeyReturn, vbKeyEscape
            ...
            For i = 1 To grdsales.rows - 1
                ...
                db.Execute "Update TRXFILE set COM_AMT = " & Val(grdsales.TextMatrix(i, 24)) & " WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='TF' AND VCH_NO = " & Val(txtBillNo.Text) & " AND LINE_NO = " & Val(grdsales.TextMatrix(i, 32)) & " "
