...
Private Sub Form_Load()
    ...
    GRDTranx.TextMatrix(0, 7) = "REF NO"
...
Private Sub GRDTranx_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    Select Case KeyCode
        Case vbKeyReturn
            ...
            RSTTRXFILE.Open "Select * From TRNXRCPT WHERE ACT_CODE = '" & DataList2.BoundText & "' AND INV_NO =  " & Val(LBLBILLNO.Caption) & "", db2, adOpenStatic, adLockReadOnly, adCmdText
...
Private Function FILLGRID()
    ...
    rstTRANX.Open "SELECT * From CRDTPYMT WHERE [ACT_CODE] = '" & DataList2.BoundText & "' AND TRX_TYPE='DR' ORDER BY INV_NO DESC", db2, adOpenStatic, adLockReadOnly, adCmdText
    Do Until rstTRANX.EOF
        ...
        GRDTranx.TextMatrix(i, 7) = rstTRANX!PINV
