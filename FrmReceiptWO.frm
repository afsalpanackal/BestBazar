...
Begin VB.Form FRMRECEIPTSHORTWO 
   BackColor       =   &H0080C0FF&
   ...
   End
End
Attribute VB_Name = "FRMRECEIPTSHORTWO"
...
Private Sub CmdSave_Click()
    ...
    db2.Execute "delete * FROM CASHATRXFILE WHERE INV_NO = " & Val(txtBillNo.Text) & " AND INV_TYPE = 'RT'"
    
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "Select * From DBTPYMT", db2, adOpenStatic, adLockOptimistic, adCmdText
    RSTTRXFILE.AddNew
...
Private Sub Form_Load()
    ...
    rstBILL.Open "Select MAX(Val(CR_NO)) From DBTPYMT WHERE TRX_TYPE = 'RT'", db2, adOpenForwardOnly
