...
Private Sub Form_Load()
    ...
    GRDTranx.ColWidth(4) = 1600
    GRDTranx.ColWidth(5) = 1800
    GRDTranx.ColWidth(6) = 1800
    GRDTranx.ColWidth(7) = 0
    GRDTranx.ColWidth(8) = 800
    ...
    GRDBILL.ColWidth(1) = 1400
    GRDBILL.ColWidth(2) = 1400
    GRDBILL.ColWidth(3) = 1400
    GRDBILL.ColWidth(4) = 1400
    GRDBILL.ColWidth(5) = 1400

    GRDBILL.ColAlignment(0) = 4
    GRDBILL.ColAlignment(1) = 4
...
Private Sub GRDTranx_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    Select Case KeyCode
        ...
        Case vbKeyF6
            ...
            'FRMRECEIPTSHORT.LBLTYPE.Caption = Trim(GRDTranx.TextMatrix(GRDTranx.Row, 7))
...
Private Function Fillgrid()
   ...
   ' On Error GoTo eRRhAND
    ...
    rstTRANX.Open "SELECT * From DBTPYMT WHERE [ACT_CODE] = '" & DataList2.BoundText & "' ORDER BY INV_NO DESC", db, adOpenStatic, adLockReadOnly, adCmdText
    Do Until rstTRANX.EOF
        ...
        'GRDTranx.TextMatrix(i, 9) = IIf(IsNull(rstTRANX!PINV), "", rstTRANX!PINV)
        GRDTranx.Row = i
        GRDTranx.Col = 0
