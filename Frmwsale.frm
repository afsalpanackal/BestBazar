...
'    End If
    ...
    If Dos_Print = False Then
        ...
        For i = 1 To Report.Database.Tables.Count
            Report.Database.Tables(i).SetLogOnInfo "ConnectionName", "D:\dbase\YEAR14-15\INVSOFT.SQL", "admin", "!@#$%^&*())(*&^%$#@!"
        Next i
...
'                            End If
                ...
                lblpack.Caption = IIf(IsNull(GRDPOPUP.Columns(14)) Or GRDPOPUP.Columns(14) = "", "1", GRDPOPUP.Columns(14))
