...
Private Sub CmdSave_Click()
    ...
    Else
        ...
        RSTITEMMAST!BANK = Trim(CMBDISTI.Text)
    ...
    'If OptCash.value = False Then db.Execute "delete FROM CASHATRXFILE WHERE TRX_TYPE = 'CR' AND INV_NO = " & Val(txtBillNo.Text) & " AND INV_TYPE = 'RT'  AND INV_TRX_TYPE = 'RT'"
    ...
    End If
    RSTTRXFILE!BR_ADDRESS = lblarea.Caption
