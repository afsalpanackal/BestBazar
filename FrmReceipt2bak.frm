...
Private Sub CmdSave_Click()
    ...
    db.Execute "delete * FROM CASHATRXFILE WHERE INV_NO = " & Val(txtBillNo.Text) & " AND INV_TYPE = 'RT' AND BILL_TRX_TYPE = '" & lblType.Caption & "'"
    ...
    RSTTRXFILE!BILL_TRX_TYPE = Trim(lblType.Caption)
    ...
    RSTITEMMAST!BILL_TRX_TYPE = Trim(lblType.Caption)
