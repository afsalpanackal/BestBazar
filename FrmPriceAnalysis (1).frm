...
Begin VB.Form FrmPriceAnalysis 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox CmbPack 
         ...
         Left            =   2385
         List            =   "FrmPriceAnalysis.frx":038A
         Style           =   2  'Dropdown List
         TabIndex        =   14
         Top             =   795
         Visible         =   0   'False
...
'        End If
        ...
        lblsalevalue.Caption = Format(Val(lblsalevalue.Caption) + (Val(GRDSTOCK.TextMatrix(i, 7)) * Val(GRDSTOCK.TextMatrix(i, 3))), "0.00")
    Next i
End Function
