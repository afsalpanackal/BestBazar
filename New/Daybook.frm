...
Private Sub CmdDayBook_Click()
    ...
    rstTRANX.Open "SELECT * From TRANSMAST WHERE VCH_DATE <= '" & Format(DTTO.value, "yyyy/mm/dd") & "' AND VCH_DATE >= '" & Format(DTFROM.value, "yyyy/mm/dd") & "' AND (TRX_TYPE='PI' OR TRX_TYPE='LP' OR TRX_TYPE='PW')", db, adOpenStatic, adLockReadOnly
    Do Until rstTRANX.EOF
        ...
        Select Case rstTRANX!TRX_TYPE
            Case "PI"
                RSTTRXFILE!VCH_DESC = "Purchase: " & rstTRANX!ACT_NAME
            Case "LP"
                RSTTRXFILE!VCH_DESC = "Local Purchase: " & rstTRANX!ACT_NAME
            Case "PW"
                RSTTRXFILE!VCH_DESC = "Petty Purchase: " & rstTRANX!ACT_NAME
        End Select
        RSTTRXFILE!Remarks = ""
    ...
    'assets purchase
    Set rstTRANX = New ADODB.Recordset
    rstTRANX.Open "select * from ASTRXMAST  WHERE VCH_DATE <= '" & Format(DTTO.value, "yyyy/mm/dd") & "' AND VCH_DATE >= '" & Format(DTFROM.value, "yyyy/mm/dd") & "' AND (TRX_TYPE='AP' OR TRX_TYPE='EP') ", db, adOpenStatic, adLockReadOnly, adCmdText
    Do Until rstTRANX.EOF
        RSTTRXFILE.AddNew
        RSTTRXFILE!TRX_TYPE = rstTRANX!TRX_TYPE
        RSTTRXFILE!VCH_NO = rstTRANX!VCH_NO
        ...
        Select Case rstTRANX!TRX_TYPE
            Case "AP"
                RSTTRXFILE!VCH_DESC = "Asset Purchase: " & rstTRANX!ACT_NAME
            Case "EP"
                RSTTRXFILE!VCH_DESC = "Expense (Input Tax): " & rstTRANX!ACT_NAME
        End Select
        RSTTRXFILE!Remarks = ""
        RSTTRXFILE!VCH_DATE = rstTRANX!VCH_DATE
        RSTTRXFILE!CREATE_DATE = rstTRANX!CREATE_DATE
    ...
    Set rstTRANX = New ADODB.Recordset
    rstTRANX.Open "select * From TRXEXPMAST WHERE VCH_DATE <= '" & Format(DTTO.value, "yyyy/mm/dd") & "' AND VCH_DATE >= '" & Format(DTFROM.value, "yyyy/mm/dd") & "' AND TRX_TYPE='EX'", db, adOpenStatic, adLockReadOnly
    Do Until rstTRANX.EOF
        RSTTRXFILE.AddNew
        RSTTRXFILE!TRX_TYPE = rstTRANX!TRX_TYPE
        RSTTRXFILE!VCH_NO = rstTRANX!VCH_NO
        RSTTRXFILE!TRX_YEAR = rstTRANX!TRX_YEAR
        RSTTRXFILE!CR_AMT = 0
        RSTTRXFILE!DR_AMT = rstTRANX!VCH_AMOUNT
        RSTTRXFILE!VCH_DESC = "Office Expense"
        RSTTRXFILE!Remarks = ""
        RSTTRXFILE!VCH_DATE = rstTRANX!VCH_DATE
        RSTTRXFILE!CREATE_DATE = rstTRANX!CREATE_DATE
        RSTTRXFILE.Update
    ...
    Set rstTRANX = New ADODB.Recordset
    rstTRANX.Open "select * From TRXINCMAST WHERE VCH_DATE <= '" & Format(DTTO.value, "yyyy/mm/dd") & "' AND VCH_DATE >= '" & Format(DTFROM.value, "yyyy/mm/dd") & "' AND TRX_TYPE='IN'", db, adOpenStatic, adLockReadOnly
    Do Until rstTRANX.EOF
        RSTTRXFILE.AddNew
        RSTTRXFILE!TRX_TYPE = rstTRANX!TRX_TYPE
        RSTTRXFILE!VCH_NO = rstTRANX!VCH_NO
        ...
        RSTTRXFILE!VCH_DESC = "Office Income"
        RSTTRXFILE!Remarks = ""
        RSTTRXFILE!VCH_DATE = rstTRANX!VCH_DATE
        RSTTRXFILE!CREATE_DATE = rstTRANX!CREATE_DATE
        RSTTRXFILE.Update
    ...
    Set rstTRANX = New ADODB.Recordset
    rstTRANX.Open "select * From TRXEXP_MAST WHERE VCH_DATE <= '" & Format(DTTO.value, "yyyy/mm/dd") & "' AND VCH_DATE >= '" & Format(DTFROM.value, "yyyy/mm/dd") & "' AND TRX_TYPE='EX'", db, adOpenStatic, adLockReadOnly
    Do Until rstTRANX.EOF
        RSTTRXFILE.AddNew
        RSTTRXFILE!TRX_TYPE = rstTRANX!TRX_TYPE
        RSTTRXFILE!VCH_NO = rstTRANX!VCH_NO
        ...
        RSTTRXFILE!CR_AMT = 0
        RSTTRXFILE!DR_AMT = rstTRANX!VCH_AMOUNT
        RSTTRXFILE!VCH_DESC = "Staff Expense"
        RSTTRXFILE!Remarks = ""
        RSTTRXFILE!VCH_DATE = rstTRANX!VCH_DATE
        RSTTRXFILE!CREATE_DATE = rstTRANX!CREATE_DATE
        RSTTRXFILE.Update
    ...
    Set rstTRANX = New ADODB.Recordset
    rstTRANX.Open "select * from STAFFPYMT WHERE INV_DATE <= '" & Format(DTTO.value, "yyyy/mm/dd") & "' AND INV_DATE >= '" & Format(DTFROM.value, "yyyy/mm/dd") & "' AND TRX_TYPE='EX'", db, adOpenStatic, adLockReadOnly
    Do Until rstTRANX.EOF
        RSTTRXFILE.AddNew
        RSTTRXFILE!TRX_TYPE = rstTRANX!TRX_TYPE
        RSTTRXFILE!VCH_NO = rstTRANX!VCH_NO
        RSTTRXFILE!TRX_YEAR = rstTRANX!TRX_YEAR
        RSTTRXFILE!CR_AMT = 0
        RSTTRXFILE!DR_AMT = rstTRANX!RCPT_AMOUNT
        RSTTRXFILE!VCH_DESC = "Staff Expense"
        RSTTRXFILE!Remarks = ""
        RSTTRXFILE!VCH_DATE = rstTRANX!VCH_DATE
        RSTTRXFILE!CREATE_DATE = rstTRANX!CREATE_DATE
    ...
    Do Until rstTRANX.EOF
        ...
        Select Case rstTRANX!TRX_TYPE
            Case "SV"
                RSTTRXFILE!VCH_DESC = "Service Bill" & IIf(IsNull(rstTRANX!ACT_NAME), "", "(" & rstTRANX!ACT_NAME & ")")
            Case "HI"
                RSTTRXFILE!VCH_DESC = "B2C Sales" & IIf(IsNull(rstTRANX!ACT_NAME), "", " (" & rstTRANX!ACT_NAME & ")")
            Case "GI"
                RSTTRXFILE!VCH_DESC = "B2B Sales" & IIf(IsNull(rstTRANX!ACT_NAME), "", " (" & rstTRANX!ACT_NAME & ")")
            Case "WO"
                RSTTRXFILE!VCH_DESC = "Petty Sales" & IIf(IsNull(rstTRANX!ACT_NAME), "", " (" & rstTRANX!ACT_NAME & ")")
        End Select
        If (rstTRANX!ACT_CODE = "130000" Or rstTRANX!ACT_CODE = "130001") Then
            RSTTRXFILE!Remarks = "Cash Sale"
        Else
    ...
    Set rstTRANX = New ADODB.Recordset
    rstTRANX.Open "select * from RETURNMAST  WHERE VCH_DATE <= '" & Format(DTTO.value, "yyyy/mm/dd") & "' AND VCH_DATE >= '" & Format(DTFROM.value, "yyyy/mm/dd") & "' AND TRX_TYPE='SR' ", db, adOpenStatic, adLockReadOnly, adCmdText
    Do Until rstTRANX.EOF
        RSTTRXFILE.AddNew
        RSTTRXFILE!TRX_TYPE = rstTRANX!TRX_TYPE
        RSTTRXFILE!VCH_NO = rstTRANX!VCH_NO
        ...
        RSTTRXFILE!CR_AMT = 0
        RSTTRXFILE!DR_AMT = rstTRANX!VCH_AMOUNT
        RSTTRXFILE!VCH_DESC = "Sales Return: " & rstTRANX!ACT_NAME
        RSTTRXFILE!Remarks = ""
        RSTTRXFILE!VCH_DATE = rstTRANX!VCH_DATE
        RSTTRXFILE!CREATE_DATE = rstTRANX!CREATE_DATE
        RSTTRXFILE.Update
    ...
    '========
    Set rstTRANX = New ADODB.Recordset
    rstTRANX.Open "SELECT * From RTRXFILE WHERE VCH_DATE <= '" & Format(DTTO.value, "yyyy/mm/dd") & "' AND VCH_DATE >= '" & Format(DTFROM.value, "yyyy/mm/dd") & "' AND (TRX_TYPE='GI' OR TRX_TYPE='HI' OR TRX_TYPE='SV') ", db, adOpenStatic, adLockReadOnly
    Do Until rstTRANX.EOF
        RSTTRXFILE.AddNew
        RSTTRXFILE!TRX_TYPE = rstTRANX!TRX_TYPE
        RSTTRXFILE!VCH_NO = rstTRANX!VCH_NO
        ...
        RSTTRXFILE!VCH_DESC = "Sales Return (Exchange): " & rstTRANX!ACT_NAME
        RSTTRXFILE!Remarks = ""
        RSTTRXFILE!VCH_DATE = rstTRANX!VCH_DATE
        RSTTRXFILE!CREATE_DATE = rstTRANX!CREATE_DATE
        RSTTRXFILE.Update
    ...
    Set rstTRANX = New ADODB.Recordset
    rstTRANX.Open "SELECT * From DBTPYMT WHERE INV_DATE <= '" & Format(DTTO.value, "yyyy/mm/dd") & "' AND INV_DATE >= '" & Format(DTFROM.value, "yyyy/mm/dd") & "'  AND (TRX_TYPE = 'RT' OR TRX_TYPE = 'RL' OR TRX_TYPE = 'PL' OR TRX_TYPE = 'FR' OR TRX_TYPE = 'FP') order by CR_NO", db, adOpenStatic, adLockReadOnly
    Do Until rstTRANX.EOF
        RSTTRXFILE.AddNew
        RSTTRXFILE!TRX_TYPE = rstTRANX!TRX_TYPE
        RSTTRXFILE!VCH_NO = rstTRANX!CR_NO
        ...
        Select Case rstTRANX!TRX_TYPE
            ...
            Case "FP"
                ...
                RSTTRXFILE!DR_AMT = rstTRANX!RCPT_AMT
        End Select
        RSTTRXFILE!Remarks = IIf(IsNull(rstTRANX!INV_NO), "", rstTRANX!INV_NO) & IIf(IsNull(rstTRANX!REF_NO) Or rstTRANX!REF_NO = "", "", ", " & rstTRANX!REF_NO)
...
'                GRDTranx.CellForeColor = vbRed
    ...
    If MDIMAIN.lblgst.Caption = "C" Then
        LBLPROFIT.Caption = Format(Round(Val(LBLNET.Caption) - (Val(lbltaxamt.Caption) + Val(lblcommi.Caption) + Val(LBLCOST.Caption)), 2), "0.00")
    ElseIf MDIMAIN.lblgst.Caption = "N" Then
