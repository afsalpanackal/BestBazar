...
Private Sub CMDADD_Click()
    ...
    grdsales.TextMatrix(Val(TXTSLNO.Text), 6) = Format(Val(TxtSale_Rate.Text), ".000")
    ...
    grdsales.TextMatrix(Val(TXTSLNO.Text), 19) = Val(txtPD.Text)
    
    grdsales.TextMatrix(Val(TXTSLNO.Text), 20) = lbltrxtype.Caption
    grdsales.TextMatrix(Val(TXTSLNO.Text), 21) = lbltrxyear.Caption
    grdsales.TextMatrix(Val(TXTSLNO.Text), 22) = lblvchno.Caption
    grdsales.TextMatrix(Val(TXTSLNO.Text), 23) = lbllineno.Caption
    ...
    If Not (RSTRTRXFILE.EOF And RSTRTRXFILE.BOF) Then
        ...
        If Not (RSTRTRXFILE2.EOF And RSTRTRXFILE2.BOF) Then
            LBLCOST.Caption = IIf(IsNull(RSTRTRXFILE2!item_COST), 0, RSTRTRXFILE2!item_COST)
    ...
    With RSTTRXFILE
        If Not (.EOF And .BOF) Then
            ...
            If Val(LBLCOST.Caption) = 0 Then LBLCOST.Caption = IIf(IsNull(!item_COST), 0, !item_COST)
...
'    Set RSTTRXFILE = Nothing
    ...
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "SELECT *  FROM RTRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= '" & Trim(creditbill.LBLTYPE.Caption) & "' AND VCH_NO = " & Val(txtBillNo.Text) & " AND ITEM_CODE='" & Trim(grdsales.TextMatrix(Val(TXTSLNO.Text), 1)) & "'AND LINE_NO=" & Val(grdsales.TextMatrix(Val(TXTSLNO.Text), 11)) & "", db, adOpenStatic, adLockOptimistic, adCmdText
    db.BeginTrans
    With RSTTRXFILE
        RSTTRXFILE.AddNew
        ...
        RSTTRXFILE!item_COST = Val(grdsales.TextMatrix(Val(TXTSLNO.Text), 8))
        RSTTRXFILE!PTR = Val(grdsales.TextMatrix(Val(TXTSLNO.Text), 8))
        RSTTRXFILE!SALES_PRICE = Val(grdsales.TextMatrix(Val(TXTSLNO.Text), 6))
        RSTTRXFILE!ITEM_SIZE = Trim(grdsales.TextMatrix(Val(TXTSLNO.Text), 15))
        RSTTRXFILE!item_color = Trim(grdsales.TextMatrix(Val(TXTSLNO.Text), 16))
...
'        End If
        ...
        RSTTRXFILE!P_DISC = Val(grdsales.TextMatrix(Val(TXTSLNO.Text), 19))
        
        RSTTRXFILE!S_TRX_TYPE = Trim(grdsales.TextMatrix(Val(TXTSLNO.Text), 20))
        RSTTRXFILE!S_TRX_YEAR = Trim(grdsales.TextMatrix(Val(TXTSLNO.Text), 21))
        RSTTRXFILE!S_VCH_NO = Val(grdsales.TextMatrix(Val(TXTSLNO.Text), 22))
        RSTTRXFILE!S_LINE_NO = Val(grdsales.TextMatrix(Val(TXTSLNO.Text), 23))
...
Private Sub Form_Load()
    ...
    If Val(creditbill.TxtCN.Text) <> 0 Then
        Set TRXMAST = New ADODB.Recordset
...
Private Sub GRDPRERATE_KeyDown(KeyCode As Integer, Shift As Integer)
    Select Case KeyCode
        Case vbKeyReturn
            ...
            TXTRATE.Text = GRDPRERATE.Columns(15)
            ...
            txtPD.Text = IIf(IsNull(GRDPRERATE.Columns(13)), "", GRDPRERATE.Columns(13))
            
            LBLCOST.Caption = IIf(IsNull(GRDPRERATE.Columns(10)), "", GRDPRERATE.Columns(10))
            
            lblvchno.Caption = IIf(IsNull(GRDPRERATE.Columns(11)), "", GRDPRERATE.Columns(11))
            lbltrxtype.Caption = IIf(IsNull(GRDPRERATE.Columns(0)), "", GRDPRERATE.Columns(0))
            lbltrxyear.Caption = IIf(IsNull(GRDPRERATE.Columns(14)), "", GRDPRERATE.Columns(14))
            lbllineno.Caption = IIf(IsNull(GRDPRERATE.Columns(12)), "", GRDPRERATE.Columns(12))
    ...
    Select Case KeyCode
        Case vbKeyReturn
            ...
            Do Until rstTRXMAST.EOF
                ...
                grdsales.TextMatrix(i, 6) = Format(rstTRXMAST!SALES_PRICE, ".000")
                grdsales.TextMatrix(i, 7) = rstTRXMAST!REF_NO
                grdsales.TextMatrix(i, 8) = IIf(IsNull(rstTRXMAST!item_COST), "", Format(rstTRXMAST!item_COST, ".000"))
                ...
                grdsales.TextMatrix(i, 19) = IIf(IsNull(rstTRXMAST!P_DISC), "", rstTRXMAST!P_DISC)
                
                grdsales.TextMatrix(i, 20) = IIf(IsNull(rstTRXMAST!S_TRX_TYPE), "", rstTRXMAST!S_TRX_TYPE)
                grdsales.TextMatrix(i, 21) = IIf(IsNull(rstTRXMAST!S_TRX_YEAR), "", rstTRXMAST!S_TRX_YEAR)
                grdsales.TextMatrix(i, 22) = IIf(IsNull(rstTRXMAST!S_VCH_NO), "", rstTRXMAST!S_VCH_NO)
                grdsales.TextMatrix(i, 23) = IIf(IsNull(rstTRXMAST!S_LINE_NO), "", rstTRXMAST!S_LINE_NO)
        ...
        Case vbKeyReturn
            ...
            If PHY.RecordCount = 1 Then
                ...
                If Not (RSTRXFILE.EOF And RSTRXFILE.BOF) Then
                    ...
                    txtPD.Text = IIf(IsNull(RSTRXFILE!LINE_DISC), "", RSTRXFILE!LINE_DISC)
    ...
    Select Case KeyCode
        Case vbKeyReturn, vbKeyTab
            ...
            If Val(TXTSLNO.Text) < grdsales.rows Then
                ...
                txtPD.Text = Val(grdsales.TextMatrix(Val(TXTSLNO.Text), 19))
                
                lbltrxtype.Caption = Trim(grdsales.TextMatrix(Val(TXTSLNO.Text), 20))
                lbltrxyear.Caption = Trim(grdsales.TextMatrix(Val(TXTSLNO.Text), 21))
                lblvchno.Caption = Val(grdsales.TextMatrix(Val(TXTSLNO.Text), 22))
                lbllineno.Caption = Val(grdsales.TextMatrix(Val(TXTSLNO.Text), 23))
...
Private Sub TxtSale_Rate_LostFocus()
    ...
    txtPD.Tag = Val(TxtSale_Rate.Text) - (Val(TxtSale_Rate.Text) * Val(txtPD.Text) / 100)
    LBLSUBTOTAL.Caption = Format(Round((Val(txtPD.Tag) * Val(TXTTAX.Text) / 100 + Val(txtPD.Tag)) * Val(TXTQTY.Text), 0), "0.000")
End Sub
...
Dim i As Long
    ...
    Select Case KeyCode
        Case vbKeyReturn
            ...
            Set RSTRXFILE = New ADODB.Recordset
            RSTRXFILE.Open "Select * From TRXFILE  WHERE BARCODE = '" & Trim(TxtBarcode.Text) & "'  ORDER BY TRX_YEAR DESC, VCH_NO DESC, TRX_TYPE DESC ", db, adOpenStatic, adLockReadOnly
            If Not (RSTRXFILE.EOF And RSTRXFILE.BOF) Then
...
Private Function FILL_PREVIIOUSRATE()
    ...
    If PRERATE_FLAG = True Then
        PHY_PRERATE.Open "Select TRX_TYPE, ITEM_CODE, ITEM_NAME, VCH_DATE, QTY, P_RETAILWOTAX, P_RETAIL, SALES_TAX, REF_NO, ITEM_SIZE, ITEM_COST, VCH_NO, LINE_NO, LINE_DISC, TRX_YEAR, MRP  From TRXFILE  WHERE ITEM_CODE = '" & TXTITEMCODE.Text & "' AND (TRX_TYPE='GI' OR TRX_TYPE='HI' OR TRX_TYPE = 'SI' OR TRX_TYPE = 'RI' OR TRX_TYPE = 'WO') AND M_USER_ID = '" & LBLCUSTOMER.Caption & "'  ORDER BY VCH_DATE DESC ", db, adOpenStatic, adLockReadOnly
        PRERATE_FLAG = False
    Else
        PHY_PRERATE.Close
        PHY_PRERATE.Open "Select TRX_TYPE, ITEM_CODE, ITEM_NAME, VCH_DATE, QTY, P_RETAILWOTAX, P_RETAIL, SALES_TAX, REF_NO, ITEM_SIZE, ITEM_COST, VCH_NO, LINE_NO, LINE_DISC, TRX_YEAR, MRP  From TRXFILE  WHERE ITEM_CODE = '" & TXTITEMCODE.Text & "' AND (TRX_TYPE='GI' OR TRX_TYPE='HI' OR TRX_TYPE = 'SI' OR TRX_TYPE = 'RI' OR TRX_TYPE = 'WO') AND M_USER_ID = '" & LBLCUSTOMER.Caption & "' ORDER BY VCH_DATE DESC ", db, adOpenStatic, adLockReadOnly
    ...
    If PHY_PRERATE.RecordCount > 0 Then
        ...
        GRDPRERATE.Columns(8).Width = 1000
        GRDPRERATE.Columns(9).Width = 1000
        ...
        GRDPRERATE.Columns(14).Width = 0
        GRDPRERATE.Columns(15).Width = 1000
...
Private Function FILL_PRERATEWITHBARCODE()
    ...
    If PRERATE_FLAG = True Then
        PHY_PRERATE.Open "Select TRX_TYPE, ITEM_CODE, ITEM_NAME, VCH_DATE, QTY, P_RETAILWOTAX, P_RETAIL, SALES_TAX, REF_NO, ITEM_SIZE, ITEM_COST, VCH_NO, LINE_NO, LINE_DISC, TRX_YEAR, MRP From TRXFILE  WHERE BARCODE = '" & Trim(TxtBarcode.Text) & "' AND (TRX_TYPE='GI' OR TRX_TYPE='HI' OR TRX_TYPE = 'SI' OR TRX_TYPE = 'RI' OR TRX_TYPE = 'WO')  ORDER BY VCH_DATE DESC, TRX_TYPE DESC, VCH_NO DESC ", db, adOpenStatic, adLockReadOnly
        PRERATE_FLAG = False
    Else
        PHY_PRERATE.Close
        PHY_PRERATE.Open "Select TRX_TYPE, ITEM_CODE, ITEM_NAME, VCH_DATE, QTY, P_RETAILWOTAX, P_RETAIL, SALES_TAX, REF_NO, ITEM_SIZE, ITEM_COST, VCH_NO, LINE_NO, LINE_DISC, TRX_YEAR, MRP From TRXFILE  WHERE BARCODE = '" & Trim(TxtBarcode.Text) & "' AND (TRX_TYPE='GI' OR TRX_TYPE='HI' OR TRX_TYPE = 'SI' OR TRX_TYPE = 'RI' OR TRX_TYPE = 'WO')  ORDER BY VCH_DATE DESC, TRX_TYPE DESC, VCH_NO DESC ", db, adOpenStatic, adLockReadOnly
...
Private Sub txtPD_LostFocus()
    txtPD.Text = Format(Val(txtPD.Text), ".000")
    'txtpd.Text = Format(txtpd.Text, ".000")
    txtPD.Tag = Val(TxtSale_Rate.Text) - (Val(TxtSale_Rate.Text) * Val(txtPD.Text) / 100)
    LBLSUBTOTAL.Caption = Format(Round((Val(txtPD.Tag) * Val(TXTTAX.Text) / 100 + Val(txtPD.Tag)) * Val(TXTQTY.Text), 0), "0.000")
End Sub
