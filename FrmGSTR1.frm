...
Begin VB.Form FRMGSTR2 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "GST BILL (B2C) - BILL - III"
   ClientHeight    =   11100
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   18495
   Icon            =   "FrmGSTR1.frx":0000
   KeyPreview      =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame FRMEMAIN 
      ...
      Begin VB.Frame FRMEHEAD 
         ...
         Begin VB.ComboBox cmbtype 
            ...
            ForeColor       =   &H00FF0000&
            Height          =   315
            ItemData        =   "FrmGSTR1.frx":030A
            Left            =   8355
            List            =   "FrmGSTR1.frx":031A
