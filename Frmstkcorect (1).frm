    ...
    With adoGrid
        ...
        If CHKCATEGORY2.Value = 0 And chkcategory.Value = 0 Then
            If OptStock.Value = True Then
                If SEARCHFLAG = 2 Then
                    .Open "SELECT ITEM_CODE, ITEM_NAME, CLOSE_QTY, PACK_TYPE, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX, ITEM_COST, ITEM_NET_COST, CUST_DISC, P_CRTN, P_LWS, CATEGORY, MANUFACTURER, CESS_PER, CESS_AMT FROM ITEMMAST WHERE (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF') AND ITEM_NAME Like '" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '" & Me.TXTITEMCODE.text & "' AND (ISNULL(REMARKS) OR REMARKS Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CLOSE_QTY <>0 ORDER BY ITEM_CODE", db, adOpenStatic, adLockOptimistic, adCmdText
                ...
                Else
                    .Open "SELECT ITEM_CODE, ITEM_NAME, CLOSE_QTY, PACK_TYPE, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX, ITEM_COST, ITEM_NET_COST, CUST_DISC, P_CRTN, P_LWS, CATEGORY, MANUFACTURER, CESS_PER, CESS_AMT FROM ITEMMAST WHERE (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF') AND ITEM_NAME Like '" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND (ISNULL(REMARKS) OR REMARKS Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CLOSE_QTY <>0 ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
                    Set RSTTRXFILE = New ADODB.Recordset
        ...
        Else
            If CHKCATEGORY2.Value = 1 Then
                If OptStock.Value = True Then
                    If SEARCHFLAG = 2 Then
                        .Open "SELECT ITEM_CODE, ITEM_NAME, CLOSE_QTY, PACK_TYPE, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX, ITEM_COST, ITEM_NET_COST, CUST_DISC, P_CRTN, P_LWS, CATEGORY, MANUFACTURER, CESS_PER, CESS_AMT FROM ITEMMAST WHERE (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '" & Me.TXTITEMCODE.text & "' AND (ISNULL(REMARKS) OR REMARKS Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND MANUFACTURER = '" & DataList1.BoundText & "' AND CLOSE_QTY <>0 ORDER BY ITEM_CODE", db, adOpenStatic, adLockOptimistic, adCmdText
                        Set RSTTRXFILE = New ADODB.Recordset
                        ...
                        Set RSTTRXFILE = Nothing
                    Else
                        .Open "SELECT ITEM_CODE, ITEM_NAME, CLOSE_QTY, PACK_TYPE, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX, ITEM_COST, ITEM_NET_COST, CUST_DISC, P_CRTN, P_LWS, CATEGORY, MANUFACTURER, CESS_PER, CESS_AMT FROM ITEMMAST WHERE (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND (ISNULL(REMARKS) OR REMARKS Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND MANUFACTURER = '" & DataList1.BoundText & "' AND CLOSE_QTY <>0 ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
                        Set RSTTRXFILE = New ADODB.Recordset
                ...
                ElseIf OptPC.Value = True Then
                    If SEARCHFLAG = 2 Then
                        .Open "SELECT ITEM_CODE, ITEM_NAME, CLOSE_QTY, PACK_TYPE, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX, ITEM_COST, ITEM_NET_COST, CUST_DISC, P_CRTN, P_LWS, CATEGORY, MANUFACTURER, CESS_PER, CESS_AMT FROM ITEMMAST WHERE PRICE_CHANGE = 'Y' and (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '" & Me.TXTITEMCODE.text & "' AND (ISNULL(REMARKS) OR REMARKS Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND MANUFACTURER = '" & DataList1.BoundText & "' ORDER BY ITEM_CODE", db, adOpenStatic, adLockOptimistic, adCmdText
                        Set RSTTRXFILE = New ADODB.Recordset
                        ...
                        Set RSTTRXFILE = Nothing
                    Else
                        .Open "SELECT ITEM_CODE, ITEM_NAME, CLOSE_QTY, PACK_TYPE, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX, ITEM_COST, ITEM_NET_COST, CUST_DISC, P_CRTN, P_LWS, CATEGORY, MANUFACTURER, CESS_PER, CESS_AMT FROM ITEMMAST WHERE PRICE_CHANGE = 'Y' and (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND (ISNULL(REMARKS) OR REMARKS Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND MANUFACTURER = '" & DataList1.BoundText & "' ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
                        Set RSTTRXFILE = New ADODB.Recordset
                ...
                Else
                    If SEARCHFLAG = 2 Then
                        .Open "SELECT ITEM_CODE, ITEM_NAME, CLOSE_QTY, PACK_TYPE, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX, ITEM_COST, ITEM_NET_COST, CUST_DISC, P_CRTN, P_LWS, CATEGORY, MANUFACTURER, CESS_PER, CESS_AMT FROM ITEMMAST WHERE (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '" & Me.TXTITEMCODE.text & "' AND (ISNULL(REMARKS) OR REMARKS Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND MANUFACTURER = '" & DataList1.BoundText & "' ORDER BY ITEM_CODE", db, adOpenStatic, adLockOptimistic, adCmdText
                        Set RSTTRXFILE = New ADODB.Recordset
                        ...
                        Set RSTTRXFILE = Nothing
                    Else
                        .Open "SELECT ITEM_CODE, ITEM_NAME, CLOSE_QTY, PACK_TYPE, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX, ITEM_COST, ITEM_NET_COST, CUST_DISC, P_CRTN, P_LWS, CATEGORY, MANUFACTURER, CESS_PER, CESS_AMT FROM ITEMMAST WHERE (ISNULL(CATEGORY) OR ucase(CATEGORY) <> 'SELF')  AND ITEM_NAME Like '" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND (ISNULL(REMARKS) OR REMARKS Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND MANUFACTURER = '" & DataList1.BoundText & "' ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
                        Set RSTTRXFILE = New ADODB.Recordset
            ...
            Else
                If OptStock.Value = True Then
                    If SEARCHFLAG = 2 Then
                        .Open "SELECT ITEM_CODE, ITEM_NAME, CLOSE_QTY, PACK_TYPE, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX, ITEM_COST, ITEM_NET_COST, CUST_DISC, P_CRTN, P_LWS, CATEGORY, MANUFACTURER, CESS_PER, CESS_AMT FROM ITEMMAST WHERE ucase(CATEGORY) <> 'SELF'  AND ITEM_NAME Like '" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '" & Me.TXTITEMCODE.text & "' AND (ISNULL(REMARKS) OR REMARKS Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CATEGORY = '" & DataList1.BoundText & "' AND CLOSE_QTY <>0 ORDER BY ITEM_CODE", db, adOpenStatic, adLockOptimistic, adCmdText
                        Set RSTTRXFILE = New ADODB.Recordset
                        ...
                        Set RSTTRXFILE = Nothing
                    Else
                        .Open "SELECT ITEM_CODE, ITEM_NAME, CLOSE_QTY, PACK_TYPE, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX, ITEM_COST, ITEM_NET_COST, CUST_DISC, P_CRTN, P_LWS, CATEGORY, MANUFACTURER, CESS_PER, CESS_AMT FROM ITEMMAST WHERE ucase(CATEGORY) <> 'SELF'  AND ITEM_NAME Like '" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND (ISNULL(REMARKS) OR REMARKS Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CATEGORY = '" & DataList1.BoundText & "' AND CLOSE_QTY <>0 ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
                        Set RSTTRXFILE = New ADODB.Recordset
                ...
                ElseIf OptPC.Value = True Then
                    If SEARCHFLAG = 2 Then
                        .Open "SELECT ITEM_CODE, ITEM_NAME, CLOSE_QTY, PACK_TYPE, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX, ITEM_COST, ITEM_NET_COST, CUST_DISC, P_CRTN, P_LWS, CATEGORY, MANUFACTURER, CESS_PER, CESS_AMT FROM ITEMMAST WHERE PRICE_CHANGE = 'Y' and ucase(CATEGORY) <> 'SELF'  AND ITEM_NAME Like '" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '" & Me.TXTITEMCODE.text & "' AND (ISNULL(REMARKS) OR REMARKS Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CATEGORY = '" & DataList1.BoundText & "' ORDER BY ITEM_CODE", db, adOpenStatic, adLockOptimistic, adCmdText
                        Set RSTTRXFILE = New ADODB.Recordset
                        ...
                        Set RSTTRXFILE = Nothing
                    Else
                        .Open "SELECT ITEM_CODE, ITEM_NAME, CLOSE_QTY, PACK_TYPE, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX, ITEM_COST, ITEM_NET_COST, CUST_DISC, P_CRTN, P_LWS, CATEGORY, MANUFACTURER, CESS_PER, CESS_AMT FROM ITEMMAST WHERE PRICE_CHANGE = 'Y' and ucase(CATEGORY) <> 'SELF'  AND ITEM_NAME Like '" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND (ISNULL(REMARKS) OR REMARKS Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CATEGORY = '" & DataList1.BoundText & "' ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
                        Set RSTTRXFILE = New ADODB.Recordset
                ...
                Else
                    If SEARCHFLAG = 2 Then
                        .Open "SELECT ITEM_CODE, ITEM_NAME, CLOSE_QTY, PACK_TYPE, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX, ITEM_COST, ITEM_NET_COST, CUST_DISC, P_CRTN, P_LWS, CATEGORY, MANUFACTURER, CESS_PER, CESS_AMT FROM ITEMMAST WHERE ucase(CATEGORY) <> 'SELF'  AND ITEM_NAME Like '" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND ITEM_CODE Like '" & Me.TXTITEMCODE.text & "' AND (ISNULL(REMARKS) OR REMARKS Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CATEGORY = '" & DataList1.BoundText & "' ORDER BY ITEM_CODE", db, adOpenStatic, adLockOptimistic, adCmdText
                        Set RSTTRXFILE = New ADODB.Recordset
                        ...
                        Set RSTTRXFILE = Nothing
                    Else
                        .Open "SELECT ITEM_CODE, ITEM_NAME, CLOSE_QTY, PACK_TYPE, MRP, P_RETAIL, P_WS, P_VAN, SALES_TAX, ITEM_COST, ITEM_NET_COST, CUST_DISC, P_CRTN, P_LWS, CATEGORY, MANUFACTURER, CESS_PER, CESS_AMT FROM ITEMMAST WHERE ucase(CATEGORY) <> 'SELF'  AND ITEM_NAME Like '" & Me.tXTMEDICINE.text & "%' AND ITEM_NAME Like '%" & Me.TxtCode.text & "%' AND (ISNULL(REMARKS) OR REMARKS Like '%" & Me.TxtHSNCODE.text & "%') AND ucase(CATEGORY) <> 'SERVICE CHARGE' AND CATEGORY = '" & DataList1.BoundText & "' ORDER BY ITEM_NAME", db, adOpenStatic, adLockOptimistic, adCmdText
                        Set RSTTRXFILE = New ADODB.Recordset
