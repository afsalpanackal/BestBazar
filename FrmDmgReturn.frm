...
Begin VB.Form frmDmgRet 
   ...
   Caption         =   "Damage Return from Customers (Credit Note)"
   ClientHeight    =   9780
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   19590
   ...
   Begin VB.Frame Fram 
      ...
      Begin VB.Frame FRMECONTROLS 
         ...
         Begin VB.ComboBox CmbPack 
            ...
            ForeColor       =   &H000000FF&
            Height          =   360
            ItemData        =   "FrmDmgReturn.frx":0000
            Left            =   8970
            List            =   "FrmDmgReturn.frx":0040
            Style           =   2  'Dropdown List
            TabIndex        =   101
            Top             =   480
            Width           =   1200
...
'    If OLD_BILL = False Then Call checklastbill
    ...
    RSTRTRXFILE.Open "SELECT * FROM DGTRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= 'DG' AND VCH_NO = " & Val(txtBillNo.text) & " AND ITEM_CODE='" & Trim(grdsales.TextMatrix(Val(TXTSLNO.text), 1)) & "'AND LINE_NO=" & Val(grdsales.TextMatrix(Val(TXTSLNO.text), 16)) & "", db, adOpenStatic, adLockOptimistic, adCmdText
    If (RSTRTRXFILE.EOF And RSTRTRXFILE.BOF) Then
        RSTRTRXFILE.AddNew
        RSTRTRXFILE!TRX_TYPE = "DG"
...
Private Sub CmdDelete_Click()
    ...
    db.Execute "delete  FROM DGTRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= 'DG' AND VCH_NO = " & Val(txtBillNo.text) & " AND ITEM_CODE='" & Trim(grdsales.TextMatrix(Val(TXTSLNO.text), 1)) & "' AND LINE_NO=" & Val(grdsales.TextMatrix(Val(TXTSLNO.text), 16)) & ""

    i = 0
    Set rstMaxNo = New ADODB.Recordset
    rstMaxNo.Open "Select MAX(LINE_NO) FROM DGTRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= 'DG' AND VCH_NO = " & Val(txtBillNo.text) & " ", db, adOpenStatic, adLockReadOnly
    ...
    Set RSTRTRXFILE = New ADODB.Recordset
    RSTRTRXFILE.Open "SELECT * FROM DGTRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= 'DG' AND VCH_NO = " & Val(txtBillNo.text) & " ORDER BY LINE_NO", db, adOpenStatic, adLockOptimistic, adCmdText
    ...
    grdsales.rows = 1
    Set RSTRTRXFILE = New ADODB.Recordset
    RSTRTRXFILE.Open "Select * FROM DGTRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= 'DG' AND VCH_NO = " & Val(txtBillNo.text) & " ORDER BY LINE_NO", db, adOpenStatic, adLockReadOnly
    Do Until RSTRTRXFILE.EOF
...
Private Sub CmdDeleteAll_Click()
    ...
    For i = 1 To grdsales.rows - 1
        db.Execute "delete  FROM DGTRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE='DG' AND VCH_NO = " & Val(txtBillNo.text) & " AND ITEM_CODE='" & Trim(grdsales.TextMatrix(i, 1)) & "' AND LINE_NO=" & Val(grdsales.TextMatrix(i, 16)) & ""
    Next i
...
Private Sub Form_Load()
    ...
    TRXMAST.Open "Select MAX(VCH_NO) FROM DGTRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= 'DG' ", db, adOpenStatic, adLockReadOnly
    'TRXMAST.Open "Select MAX(VCH_NO) From DAMAGEMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE = 'DG'", db, adOpenStatic, adLockReadOnly
...
Private Sub Form_Unload(Cancel As Integer)
    If CLOSEALL = 0 Then
        If grdsales.rows <= 1 Then db.Execute "delete From DAMAGEMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= 'DG' AND VCH_NO = " & Val(txtBillNo.text) & ""
...
Private Sub grdtmp_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    Select Case KeyCode
        Case vbKeyReturn
            ...
            RSTRXFILE.Open "Select * FROM DGTRXFILE  WHERE ITEM_CODE = '" & Trim(TXTITEMCODE.text) & "' ORDER BY CREATE_DATE", db, adOpenStatic, adLockReadOnly, adCmdText
...
Private Sub TXTBILLNO_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    Select Case KeyCode
        Case vbKeyReturn
            ...
            rstTRXMAST.Open "Select * FROM DGTRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= 'DG' AND VCH_NO = " & Val(txtBillNo.text) & " ORDER BY LINE_NO", db, adOpenStatic, adLockReadOnly
            ...
            Set rstTRXMAST = New ADODB.Recordset
            rstTRXMAST.Open "Select * From DAMAGEMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= 'DG' AND VCH_NO = " & Val(txtBillNo.text) & "", db, adOpenStatic, adLockOptimistic, adCmdText
            ...
            RSTTRNSMAST.Open "Select CHECK_FLAG From DAMAGEMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= 'DG' AND VCH_NO = " & Val(txtBillNo.text) & "", db, adOpenStatic, adLockReadOnly
...
'            End If
            ...
            If PHY.RecordCount = 1 Then
                ...
                Set RSTRXFILE = New ADODB.Recordset
                RSTRXFILE.Open "Select * FROM DGTRXFILE  WHERE ITEM_CODE = '" & Trim(TXTITEMCODE.text) & "' ORDER BY CREATE_DATE", db, adOpenStatic, adLockReadOnly
                If Not (RSTRXFILE.EOF And RSTRXFILE.BOF) Then
                    RSTRXFILE.MoveLast
                    TXTUNIT.text = 1 'IIf(IsNull(RSTRXFILE!UNIT), "", RSTRXFILE!UNIT)
...
Public Sub appendpurchase()
    ...
    db.Execute "delete From DAMAGEMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= 'DG' AND VCH_NO = " & Val(txtBillNo.text) & ""
    db.Execute "delete FROM CASHATRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND INV_NO = " & Val(txtBillNo.text) & " AND INV_TYPE = 'DG' AND INV_TRX_TYPE = 'DG'"
    ...
    If lblcredit.Caption = "0" Then
        ...
        RSTITEMMAST.Open "SELECT * FROM CASHATRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND INV_NO = " & Val(txtBillNo.text) & " AND INV_TYPE = 'DG' AND INV_TRX_TYPE = 'DG'", db, adOpenStatic, adLockOptimistic, adCmdText
        If (RSTITEMMAST.EOF And RSTITEMMAST.BOF) Then
            RSTITEMMAST.AddNew
            RSTITEMMAST!REC_NO = i + 1
            RSTITEMMAST!INV_TYPE = "DG"
            RSTITEMMAST!INV_TRX_TYPE = "DG"
    ...
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "Select * From DAMAGEMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= 'DG' AND VCH_NO = " & Val(txtBillNo.text) & "", db, adOpenStatic, adLockOptimistic, adCmdText
    ...
    Set RSTTRXFILE = New ADODB.Recordset
    RSTTRXFILE.Open "SELECT * FROM DGTRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= 'DG' AND VCH_NO = " & Val(txtBillNo.text) & "", db, adOpenStatic, adLockOptimistic, adCmdText
    Do Until RSTTRXFILE.EOF
        RSTTRXFILE!VCH_DATE = Format(Trim(TXTINVDATE.text), "dd/mm/yyyy")
        RSTTRXFILE!VCH_DESC = "Damage from   " & Mid(DataList2.text, 1, 80)
        RSTTRXFILE!M_USER_ID = DataList2.BoundText
        RSTTRXFILE.Update
        RSTTRXFILE.MoveNext
    Loop
...
SKIP:
    Set rstMaxNo = New ADODB.Recordset
    'rstMaxNo.Open "Select MAX(VCH_NO) From DAMAGEMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE= 'DG'", db, adOpenStatic, adLockReadOnly
    rstMaxNo.Open "Select MAX(VCH_NO) FROM DGTRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= 'DG' ", db, adOpenStatic, adLockReadOnly
    If Not (rstMaxNo.EOF And rstMaxNo.BOF) Then
...
Private Function checklastbill()
    ...
    rstBILL.Open "Select MAX(VCH_NO) FROM DGTRXFILE WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.Value) & "' AND TRX_TYPE= 'DG' ", db, adOpenStatic, adLockReadOnly
    'rstBILL.Open "Select MAX(VCH_NO) From DAMAGEMAST WHERE TRX_YEAR='" & Year(MDIMAIN.DTFROM.value) & "' AND TRX_TYPE= 'DG'", db, adOpenForwardOnly
